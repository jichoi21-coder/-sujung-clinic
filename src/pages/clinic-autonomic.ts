export const clinic_autonomicPage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>자율신경·뇌신경 클리닉 | 두통·어지럼증·이명·불면증·공황장애 – 수정한의원</title>
  <meta name="description" content="원인 모를 두통·편두통, 만성 어지럼증, 이명·난청, 불면증·만성피로, 우울증·공황장애. 검사에 이상 없다는데 계속 힘드시다면? 8체질로 자율신경 불균형 근본 원인을 찾습니다. 노원구 한의원."/>
  ...
  <link rel="canonical" href="https://www.8chejil-sujeong.com/clinic/autonomic"/>

  <!-- Open Graph -->
  <meta property="og:title" content="자율신경·뇌신경 클리닉 | 두통·어지럼증·이명·불면증·공황장애 – 수정한의원"/>
  <meta property="og:description" content="원인 모를 두통·편두통, 만성 어지럼증, 이명·난청, 불면증·만성피로, 우울증·공황장애. 검사에 이상 없다는데 계속 힘드시다면? 8체질로 자율신경 불균형 근본 원인을 찾습니다. 노원구 한의원."/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/clinic/autonomic"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="자율신경·뇌신경 클리닉 | 두통·어지럼증·이명·불면증·공황장애 – 수정한의원"/>
  <meta name="twitter:description" content="원인 모를 두통·편두통, 만성 어지럼증, 이명·난청, 불면증·만성피로, 우울증·공황장애. 검사에 이상 없다는데 계속 힘드시다면? 8체질로 자율신경 불균형 근본 원인을 찾습니다. 노원구 한의원."/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"자율신경·뇌신경 클리닉","item":"https://8chejil-sujeong.com/clinic/autonomic"}]},{"@type":"MedicalCondition","name":"두통·편두통","associatedAnatomy":{"@type":"AnatomicalStructure","name":"뇌신경"},"possibleTreatment":{"@type":"MedicalTherapy","name":"8체질 침치료·한약치료"}},{"@type":"MedicalCondition","name":"어지럼증"},{"@type":"MedicalCondition","name":"이명·난청"},{"@type":"MedicalCondition","name":"불면증·만성피로"},{"@type":"MedicalCondition","name":"공황장애·우울증"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 자율신경·뇌신경</div>
    <h1>자율신경·뇌신경 클리닉</h1>
    <p>원인을 모를수록, 체질을 먼저 봅니다</p>
  </div>
</section>
<section class="clinic-intro bg-cream">
  <div class="section-container">
    <div class="clinic-intro-badge"><i class="fas fa-brain"></i> 자율신경·뇌신경 클리닉</div>
    
    <div class="auto-wrap">

      <!-- Hero -->
      <div class="auto-hero-box">
        <div class="auto-hero-main">검사엔 이상 없다는데,<br/>왜 이렇게 힘들까요?</div>
        <div class="auto-hero-sub">두통, 어지럼증, 불면, 이명, 불안, 만성 피로 — 원인 없는 고통은 없습니다.<br/>수정한의원이 체질에서 답을 찾습니다.</div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>자율신경 실조란 무엇인가요?</span>
        </div>
        <div class="auto-q-body">
          <p>자율신경은 심박, 호흡, 소화, 체온, 수면 등 의지와 무관하게 작동하는 생명 유지 시스템입니다. 교감신경(긴장·활성)과 부교감신경(이완·회복)이 균형을 이루어야 정상 기능하지만, 이 균형이 무너지면 특정 장기가 아닌 <strong>몸 전체에 다양한 증상이 동시다발적으로 나타납니다.</strong></p>
          <div class="auto-highlight-box">검사 결과에는 큰 이상이 없어 "스트레스성"으로 분류되는 경우가 많지만, 환자가 느끼는 고통은 매우 실질적입니다.</div>
        </div>
      </div>

      <!-- 자율신경 시스템 이미지 -->
      <div class="auto-img-wrap">
        <img src="/static/autonomic-nervous-system.jpg" alt="교감신경·부교감신경 시스템 — 뇌, C1-C2 경추, TMJ, 심장, 폐, 위장, 장" class="auto-system-img"/>
        <p class="auto-img-caption">교감신경(주황)과 부교감신경(청록)의 균형이 무너지면 뇌·심장·소화기·면역 전반에 동시다발적 이상이 발생합니다</p>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>어떤 증상이 해당되나요?</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-symptom-table">
              <thead>
                <tr><th>영역</th><th>주요 증상</th></tr>
              </thead>
              <tbody>
                <tr><td class="ast-label">두뇌·신경</td><td>두통, 편두통, 어지럼증, 이명, 난청</td></tr>
                <tr><td class="ast-label">수면·피로</td><td>불면증, 수면장애, 만성 피로, 기상 후 피곤</td></tr>
                <tr><td class="ast-label">심장·순환</td><td>가슴 두근거림, 흉통, 손발 저림·냉감</td></tr>
                <tr><td class="ast-label">정서·정신</td><td>불안감, 공황장애, 우울증, 홧병, 감정 기복</td></tr>
                <tr><td class="ast-label">소화·기타</td><td>소화불량, 과민성 장, 구건, 다한, 안구건조</td></tr>
              </tbody>
            </table>
          </div>
          <div class="auto-highlight-box"><strong>핵심:</strong> 이 증상들은 하나씩 나타나기도, 여러 개가 동시에 나타나기도 합니다. "검사는 정상인데 몸이 아프다"면 자율신경 문제를 의심해야 합니다.</div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 일반 치료로는 잘 낫지 않나요?</span>
        </div>
        <div class="auto-q-body">
          <p>양방에서는 증상별로 약을 처방합니다 — 두통엔 진통제, 불면엔 수면제, 불안엔 항불안제.</p>
          <div class="auto-highlight-box"><strong>자율신경 실조의 본질은 '개별 증상'이 아니라 '신경 균형의 붕괴'</strong>이기 때문에, 약으로 하나를 누르면 다른 증상이 올라오는 악순환이 반복됩니다. 약물 의존도가 높아지면서 자체 조절력은 더욱 떨어지게 됩니다.</div>
        </div>
      </div>
            ...
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>30년·21,560건 이상의 데이터 기반 체질 확정 → 교감·부교감 불균형의 체질적 원인 파악</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 8체질 침 치료</td>
                  <td>체질별 장부 강약에 맞춘 침 처방으로 자율신경 직접 조절</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-bone"></i> 경추 1‑2 교정 추나요법</td>
                  <td>상부 경추는 뇌간·자율신경 중추와 직결 — C1‑C2 미세 변위 교정으로 뇌간→자율신경 신호 전달 정상화</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-teeth"></i> 턱관절(TMJ) 교정 치료</td>
                  <td>턱관절 불균형은 삼차신경을 통해 두통·이명·어지럼증 유발 — 교합·관절 정렬을 바로잡아 두개안면 신경 자극 원인 제거</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-syringe"></i> 약침요법</td>
                  <td>한약 유효 성분을 경혈에 직접 주입 → 항염·신경 안정 효과를 경혈 자극 + 약물 흡수 이중 경로로 전달</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-thread"></i> 매선요법</td>
                  <td>약리 성분이 포함된 실을 경혈·근막에 매입 → 지속적 자극으로 근긴장 완화·혈류 개선·자율신경 안정 효과 연장</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-leaf"></i> 체질 맞춤 한약</td>
                  <td>과항진된 장부는 억제, 약화된 장부는 보강 → 신경 균형의 근본 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-wave-square"></i> 빔레이 파동요법</td>
                  <td>저에너지 전자기장으로 신경 전달 환경 정상화, 긴장 완화 보조</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-circle-dot"></i> 양자돔 + 생활관리</td>
                  <td>전신 이완·면역 회복, 체질별 식이·수면·운동 지도</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="auto-flow-box">
            <strong>핵심 차이:</strong> 같은 불면이라도 금양체질의 불면과 목양체질의 불면은 원인 장부가 다르고, 경추·턱관절의 구조적 문제가 겹치면 증상은 더 복합적으로 나타납니다. <strong>체질 진단 + 구조 교정 + 한방 치료를 동시에 설계</strong>하는 것이 수정한의원의 차별점입니다.
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>8체질 진단이 왜 중요한가요?</span>
        </div>
        <div class="auto-q-body">
          <p>자율신경 실조 증상이 동일해도, <strong>체질에 따라 과항진되는 장부와 약화되는 장부가 다릅니다.</strong></p>
          <div class="auto-constitution-list">
            <div class="auto-const-item">
              <span class="auto-const-icon">⚡</span>
              <span>어떤 체질은 <strong>교감신경이 쉽게 항진</strong>되어 불안·두근거림·불면이 주 증상이 되고,</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🌊</span>
              <span>어떤 체질은 <strong>부교감신경 회복력이 부족</strong>해 만성 피로·소화불량·무기력이 지속됩니다.</span>
            </div>
          </div>
          <div class="auto-stat-box">
            <span class="auto-stat-icon">📊</span>
            <span>수정한의원은 한의학박사(침구학 전공)의 <strong>30년 임상</strong>과 <strong>21,560건 이상</strong>의 체질 진단 데이터를 통해 8체질을 정밀 확정하고, 그 체질에 맞는 침·한약·구조 교정·생활 관리를 설계합니다.</span>
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        ...
        <div class="auto-q-body">
          <div class="auto-highlight-box" style="border-left-color:#2e7d32; background:#f1f8f3;">
            ...
            현재 복용 중인 약(수면제, 항불안제, 항우울제 등)을 유지하면서 체질 치료를 병행할 수 있습니다. 자율신경 균형이 회복되면서 양방 약물을 점진적으로 줄여가는 것이 목표이며, 진료 시 현재 복용 약물을 알려주시면 통합 치료 계획을 수립합니다.
          </div>
        </div>
      </div>
      ...
      <div class="sdi-cta-box" style="margin-top:28px;">
        <div class="sdi-cta-concerns">
          <span>"검사엔 이상 없다는데 계속 아파요"</span>
          <span>"수면제 없이는 잠을 못 자요"</span>
          <span>"불안과 두근거림이 반복돼요"</span>
          <span>"여러 병원 다녀도 달라지지 않아요"</span>
        </div>
        <p class="sdi-cta-lead">자율신경 문제는 <strong>체질의 문제 + 구조의 문제</strong>입니다.<br/>8체질 정밀 진단 + 경추·턱관절 교정에서 답을 찾으세요.</p>
