export const clinic_womenPage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>여성질환 클리닉 | 생리통·난임·계류유산·산후조리·갱년기 – 수정한의원</title>
  <meta name="description" content="생리통·생리불순, 난임·계류유산, 산후조리·산후보약, 갱년기증후군. 체질 맞춤 한약으로 여성 건강 근본 회복. 임신 준비부터 출산 후 회복까지. 노원구 한의원."/>
  ...
  <link rel="canonical" href="https://www.8chejil-sujeong.com/clinic/women"/>

  <!-- Open Graph -->
  <meta property="og:title" content="여성질환 클리닉 | 생리통·난임·계류유산·산후조리·갱년기 – 수정한의원"/>
  <meta property="og:description" content="생리통·생리불순, 난임·계류유산, 산후조리·산후보약, 갱년기증후군. 체질 맞춤 한약으로 여성 건강 근본 회복. 임신 준비부터 출산 후 회복까지. 노원구 한의원."/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/clinic/women"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="여성질환 클리닉 | 생리통·난임·계류유산·산후조리·갱년기 – 수정한의원"/>
  <meta name="twitter:description" content="생리통·생리불순, 난임·계류유산, 산후조리·산후보약, 갱년기증후군. 체질 맞춤 한약으로 여성 건강 근본 회복. 임신 준비부터 출산 후 회복까지. 노원구 한의원."/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"여성질환 클리닉","item":"https://8chejil-sujeong.com/clinic/women"}]},{"@type":"MedicalCondition","name":"생리통·생리불순"},{"@type":"MedicalCondition","name":"난임·계류유산"},{"@type":"MedicalCondition","name":"산후조리·산후보약"},{"@type":"MedicalCondition","name":"갱년기증후군"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 여성질환 클리닉</div>
    <h1>여성질환 클리닉</h1>
    <p>정확한 8체질 진단으로 여성질환의 근본 원인을 찾습니다</p>
  </div>
</section>
...
<section class="bg-cream">
  <div class="section-container">
    ...
    <div class="auto-wrap">
      ...
      <!-- 인트로 Hero -->
      <div class="auto-hero-box" style="background:linear-gradient(135deg,#3a0a2a 0%,#6b1a4a 60%,#3a0a2a 100%); margin-bottom:24px;">
        <div class="auto-hero-main">여성의 몸은 일생에 세 번, 크게 변합니다</div>
        <div class="auto-hero-sub">초경 · 임신·출산 · 갱년기·폐경 — 이 시기마다 가장 큰 호르몬 변동을 경험합니다.<br/>수정한의원은 각 시기별 여성질환을 증상이나 호르몬 수치만으로 보지 않고,<br/><strong style="color:#f0c0e0;">정확한 8체질 진단</strong>을 바탕으로 체질 중심의 근본 치료를 시행합니다.</div>
      </div>

      <!-- 도입 설명 -->
      <div class="auto-q-block" style="margin-bottom:18px;">
        <div class="auto-q-body">
          <p>이러한 시기에는 몸이 평소보다 더 예민해지고, 작은 불균형도 여성질환으로 이어지는 경우가 적지 않습니다. 특히 호르몬 변화는 전반적인 면역 상태에까지 영향을 미치기 때문에, 면역력이 저하된 상태에서는 이 변화를 견뎌내기가 더욱 어려워질 수 있습니다.</p>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>어떤 여성질환을 치료하나요?</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead><tr><th>질환</th><th>주요 증상</th></tr></thead>
              <tbody>
                <tr>
                  <td class="att-label">생리통·생리불순</td>
                  <td>주기적 하복부 통증·허리 통증, 주기 불규칙·양 과다 또는 과소</td>
                </tr>
                <tr>
                  <td class="att-label">다낭성 난소 증후군(PCOS)</td>
                  <td>생리 불순·무월경, 여드름·다모증, 체중 증가, 인슐린 저항</td>
                </tr>
                <tr>
                  <td class="att-label">PMS(월경전증후군)</td>
                  <td>생리 전 유방 팽만·두통·부종·감정 기복·식욕 변화</td>
                </tr>
                <tr>
                  <td class="att-label">자궁근종</td>
                  <td>생리량 과다·덩어리 혈, 하복부 압박감·빈뇨</td>
                </tr>
                <tr>
                  <td class="att-label">자궁내막증</td>
                  <td>극심한 생리통·만성 골반통, 성교통, 배변통</td>
                </tr>
                <tr>
                  <td class="att-label">난임·불임</td>
                  <td>규칙적 관계에도 1년 이상 미임신, 난소 예비력 저하, 착상 실패 반복</td>
                </tr>
                <tr>
                  <td class="att-label">계류유산 예방</td>
                  <td>반복 유산 이력, 착상 불안정, 자궁 환경 취약 — 임신 유지를 위한 체질 관리</td>
                </tr>
                <tr>
                  <td class="att-label">산후보약·산후풍</td>
                  <td>출산 후 전신 관절통·냉감·부종·피로·우울</td>
                </tr>
                <tr>
                  <td class="att-label">갱년기 증후군</td>
                  <td>안면 홍조·발한·불면·우울·불안·질 건조·골밀도 저하</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 체질에 따라 여성질환이 다르게 나타나나요?</span>
        </div>
        <div class="auto-q-body">
          <p>같은 생리통이라도 원인 장부가 체질마다 다릅니다.</p>
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead><tr><th>체질</th><th>여성질환 특성</th><th>핵심 기전</th></tr></thead>
              <tbody>
                <tr>
                  <td class="att-label">목양·목음</td>
                  <td>간·담 과항진 → 기울(氣鬱)·어혈 축적 → 생리통·자궁내막증·PMS 감정 기복</td>
                  <td>간 기능 조절 + 어혈 제거</td>
                </tr>
                <tr>
                  <td class="att-label">금양·금음</td>
                  <td>간 약화 → 해독·혈액 저장 부족 → 생리량 과다·자궁근종 성장 촉진·난임</td>
                  <td>간 보강 + 자궁 환경 개선</td>
                </tr>
                <tr>
                  <td class="att-label">토양·토음</td>
                  <td>위장·췌장 과항진 → 습열·담음 축적 → 다낭성 난소·비만형 생리불순·인슐린 저항</td>
                  <td>습열 제거 + 체중·대사 관리</td>
                </tr>
                <tr>
                  <td class="att-label">수양·수음</td>
                  <td>신장·자궁 냉허(冷虛) → 자궁 혈류 저하 → 냉성 생리통·착상 장애·산후풍·계류유산 위험</td>
                  <td>신장 보강 + 자궁 보온</td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="auto-highlight-box">
            호르몬제나 진통제는 일시적으로 증상을 억제할 수 있지만, <strong>체질적 원인이 해결되지 않으면 약을 끊는 순간 다시 반복됩니다.</strong>
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>호르몬제·진통제만으로는 왜 한계가 있나요?</span>
        </div>
        <div class="auto-q-body">
          <p>양방 치료는 호르몬 수치를 직접 조절하거나 통증 신호를 차단하는 데 초점을 맞춥니다. 그러나 여성질환은 자율신경·면역·장부 균형이 복합적으로 작용하므로, 한 가지 수치만 바꿔서는 근본 개선이 어렵습니다.</p>
          <div class="auto-highlight-box">
            체질에 따라 <strong>과항진된 장부를 억제하고 약화된 장부를 보강해야</strong> 호르몬·면역·자율신경이 함께 안정됩니다.
          </div>
        </div>
      </div>
            ...
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>30년·21,560건 데이터 기반 체질 확정 — 장부 강약·자율신경 유형·호르몬 불균형 방향 파악</td>
                </tr>
                <tr>
                  <td class="att-label">② 체질 맞춤 한약</td>
                  <td>체질별 어혈 제거·습열 배출·냉허 보강 등 근본 처방, 자궁·난소 환경 정상화</td>
                </tr>
                <tr>
                  <td class="att-label">③ 척추 배수혈 침 치료</td>
                  <td>간수·비수·신수·삼초수 등 자율신경이 출입하는 배수혈 자극으로 장부 균형 직접 조절</td>
                </tr>
                <tr>
                  <td class="att-label">④ 8체질 침 치료</td>
                  <td>체질별 장부 강약에 맞춘 침법으로 면역·호르몬·자율신경 통합 조절</td>
                </tr>
                <tr>
                  <td class="att-label">⑤ 약침요법</td>
                  <td>한약 유효성분을 경혈에 주입 — 자궁·골반 혈류 개선, 항염·어혈 제거</td>
                </tr>
                <tr>
                  <td class="att-label">⑥ 매선요법</td>
                  <td>약실을 경혈·근막에 매입 — 지속적 자극으로 골반 순환·근긴장 개선</td>
                </tr>
                <tr>
                  <td class="att-label">⑦ 양자돔 + 생활관리</td>
                  <td>전신 이완·면역 회복, 체질별 식단·수면·운동·스트레스 관리 지도</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>난임 치료에도 효과가 있나요?</span>
        </div>
        <div class="auto-q-body">
          <p>한의표준임상진료지침에 따르면, 보조생식술(IVF·IUI)과 한약·침 치료를 병행했을 때 임신 관련 지표가 개선되는 것으로 보고되고 있습니다. 특히 난소 예비력 저하(AMH 수치 저하) 여성에게 체질 한약이 난소 기능 회복에 도움이 되는 임상 보고가 있습니다.</p>
          <div class="auto-highlight-box">
            수정한의원은 <strong>시험관·인공수정 스케줄에 맞춰 체질 치료를 설계</strong>하므로, 현재 난임 시술을 받고 계셔도 안심하고 병행할 수 있습니다.
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>계류유산을 예방할 수 있나요?</span>
        </div>
        <div class="auto-q-body">
          <p>네, 가능합니다. 계류유산은 태아의 심박이 확인되지 않거나 성장이 멈추는 상태로, 자궁 내 혈류 부족·면역 불균형·호르몬 불안정이 복합적으로 작용하여 발생합니다.</p>
          <p>8체질의학에서는 체질에 맞지 않는 음식이 계류유산의 숨은 원인이 될 수 있다고 봅니다. 영양학적으로는 좋은 음식이라 하더라도, 본인의 체질에 맞지 않으면 장기의 균형이 깨지면서 강한 장기는 더 강해지고 약한 장기는 더 약해지는 미세한 변화가 일어납니다.</p>
          <p>특히 극도의 안정이 필요한 임신 초기, 자궁 기능이 취약한 산모가 체질에 맞지 않는 음식을 지속적으로 섭취하거나 과도한 스트레스·과로가 겹치면 자궁 내 혈류 부족과 호르몬 불안정이 심화되어 계류유산으로 이어질 수 있습니다.</p>
          <div class="auto-highlight-box">
            과로나 스트레스가 유산에 영향을 준다는 것은 많이 알려져 있지만, <strong>매일 먹는 음식이 계류유산을 촉진할 수 있다는 사실</strong>은 대부분 상상하지 못합니다.<br/>
            그렇기 때문에 <strong>임신 전, 그리고 임신 초기에 정확한 8체질 진단이 반드시 필요합니다.</strong>
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>시기별 맞춤 치료가 가능한가요?</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead><tr><th>시기</th><th>치료 방향</th></tr></thead>
              <tbody>
                <tr>
                  <td class="att-label">초경·사춘기</td>
                  <td>체질 진단 후 생리 주기 안정화, 성조숙증 관리, 성장 치료 병행 가능</td>
                </tr>
                <tr>
                  <td class="att-label">가임기(생리통·PCOS·근종·난임)</td>
                  <td>어혈·습열·냉허 등 체질 원인 제거, 자궁·난소 환경 최적화</td>
                </tr>
                <tr>
                  <td class="att-label">임신 준비·유산 예방</td>
                  <td>자궁 내막 강화, 착상 환경 조성, 계류유산·반복 유산 체질적 예방</td>
                </tr>
                <tr>
                  <td class="att-label">임신·출산</td>
                  <td>산전 체질 관리(입덧·부종·요통), 산후보약·산후풍 집중 치료</td>
                </tr>
                <tr>
                  <td class="att-label">갱년기·폐경</td>
                  <td>호르몬 급감에 따른 홍조·불면·골밀도 저하를 체질별 한약·침으로 완화</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="auto-q-block">
        ...
        <div class="auto-q-body">
          <p>현재 복용 중인 호르몬제(피임약·HRT), 배란유도제, 진통제, 난임 시술 등과 체질 치료는 병행 가능합니다. 내원 시 현재 치료 상황과 복용 약물을 알려 주시면 통합 치료 계획을 세워 드립니다.</p>
          <div class="auto-highlight-box" style="background:#f0f7f2; border-left-color:#1a5c3a; color:#1a3d28;">
            체질 치료가 진행되면서 <strong>호르몬제·진통제를 점진적으로 줄여가는 것을 목표</strong>로 합니다.
          </div>
        </div>
      </div>
      ...
      <div class="asthma-cta-box">
        <div class="asthma-cta-tags">
          <span class="asthma-cta-tag">"생리통이 점점 심해져요"</span>
          <span class="asthma-cta-tag">"다낭성 난소라고 하는데 피임약 외에 방법이 없나요?"</span>
          <span class="asthma-cta-tag">"시험관 3회 실패, 다른 방법이 없을까요?"</span>
          <span class="asthma-cta-tag">"유산이 반복돼서 다음 임신이 두려워요"</span>
          <span class="asthma-cta-tag">"출산 후 온몸이 쑤시고 추워요"</span>
          <span class="asthma-cta-tag">"갱년기 증상으로 잠을 못 자요"</span>
        </div>
        <p class="asthma-cta-lead">정확한 8체질 진단으로 여성질환의 체질적 원인을 찾고,<br/><strong>시기에 맞는 근본 치료를 시작하세요.</strong></p>
