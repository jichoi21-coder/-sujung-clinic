...
<script src="/static/app.js"></script>
    ...
    <section class="review-list-section sec-wrap">
      ...
      <div class="review-grid summary-mode" id="reviewGrid">
        ...
        <div id="reviewCard182" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal182')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">허리디스크 — 약침·추나·물리치료로 금방 치료된 것 같아요, 허리 안 좋으신 분 꼭 내원해보세요</h3>
          <p class="review-story">
            허리디스크로 내원했는데 진료와 치료를 잘해주셔서 금방 치료가 된 것 같아요. 약침·물리치료·추나로 받았습니다. 허리 안 좋으신 분 내원하셔서 치료 받아보세요.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 소르기이 경기의정부</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <!-- 후기 카드 #169 -->
        <div id="reviewCard169" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal169')" style="cursor:pointer;">
          <div class="review-card-header">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">왼쪽 팔꿈치 테니스 엘보우 — 체질 맞춤 한약·침 병행으로 일상생활 불편함이 많이 호전됐어요</h3>
          <p class="review-story">
            왼쪽 팔꿈치 알보로 인해 일상생활이 불편하여 수정한의원 방문. 8체질 의학을 접하게 되었고 체질에 맞는 한약을 먹으며 침치료, 약침을 병행하여 현재 상태가 많이 호전되었어요.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 유리바다1</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard166" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal166')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">어려서부터 척추측만증·요통·어깨통증 — 추나·약침 후 잠깐의 치료에도 머리가 맑아지고 통증이 사라져서 놀랐어요</h3>
          <p class="review-story">
            원장님께서 몸 상태와 통증 원인을 잘 설명해주시고 추나·약침을 손수 놓아주셨어요. 잠깐의 치료에도 머리가 맑아지고 통증이 사라져서 놀랐습니다. 미루던 치료를 지속적으로 다녀보려 합니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 데니카쓰 (남)</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard156" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal156')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">흉곽출구증후군</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2025.07</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">흉곽출구증후군으로 팔 통증이 심각했는데 — 태반약침·체질침으로 호전, 체질 알고 식이요법까지 챙길 수 있어요</h3>
          <p class="review-story">여섯 번째 침치료까지 받으며 통증이 완화되니 살 것 같습니다. 체질을 알게 돼 식이요법도 더 철저히 진행되고 있어요. 가족 모두에게 적극 추천 중입니다.</p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 김은별팀장</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
          <div class="review-card-click-hint"><i class="fas fa-expand-alt"></i> 클릭하여 자세히 보기</div>
                ...
                <!-- 후기 카드 #155 -->
        <div id="reviewCard155" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal155')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">허리통증</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2025.07</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">허리 통증으로 앉거나 걷기 힘들었는데 — 교정 치료 후 많이 나아지고, 매번 꼼꼼히 확인해주셔서 편안하게 치료받았어요</h3>
          <p class="review-story">매번 올 때마다 불편한 점은 없는지, 많이 나아졌는지 꼼꼼히 확인해주신 덕분에 편안하게 치료받을 수 있었어요!</p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 이정원707</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard153" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal153')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">디스크성 어깨통증</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2025.05</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">한 달간 왼쪽 어깨·팔뚝 통증 — 첫날 물리치료·침·추나로 드라마틱한 효과를 바로 느꼈어요</h3>
          <p class="review-story">
            한 달 전부터 왼쪽 어깨·팔뚝이 아파서 정형외과도 다녀보고 약도 먹어봤는데 낫지 않았습니다. 우연히 수정한의원을 알게 되어 원장님 상담 후 물리치료·침치료·추나치료를 받았는데, 드라마틱하게 효과가 바로 있었습니다. 원장님 설명도 잘해주시고 직원분들도 친절하시고 감사합니다^^
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 조찬형50</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard148" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal148')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">일자목 경추통증</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2025.02</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">일자목 1년 고생 — 첫날 단 한 번의 치료로 효과 느껴 내일 또 치료 예정이에요</h3>
          <p class="review-story">
            일자목으로 1년 정도 불편하게 지내던 중 가족 소개로 내원했습니다. 소파에 앉아 TV 보거나 무거운 것 조금만 들어도 목이 불편했는데, 당일 내원 후 한 번의 치료로 효과를 느끼니 너무 좋고 내일 또 치료 예정입니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> ekmgg</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard141" class="review-card" data-cat="소화기" onclick="openReviewModal('detailModal141')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">위경련 피부발진</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2024.08</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">위경련·피부 발진으로 고생 — 약침·한약·팔체질 식사로 속이 편안해지고 증상 호전됐어요</h3>
          <p class="review-story">
            위경련과 피부 발진으로 고생하여, 지인 소개로 오게됐습니다. 꾸준하게 약침과 한약을 먹으며 치료 받으니 속이 편안하고 증상이 호전되었습니다. 팔체질 식사로 건강해졌습니다. 친절한 원장님과 선생님들께 감사드려요!
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> sw****</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard139" class="review-card" data-cat="뇌신경" onclick="openReviewModal('detailModal139')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">돌발성 난청·이명으로 일상이 무너졌는데 — 원장님의 꾸준한 치료로 기적같이 완치, 이명도 고칠 수 있습니다!</h3>
          <p class="review-story">
            돌발성 난청·이명으로 일상생활이 어려울 정도로 힘들었는데 원장님의 치료로 기적같이 완치되었습니다. 양약으로 안 되는 경우를 종종 봤지만 수정한의원은 달랐습니다. 원장님의 지극한 정성·연구와 가족같은 친절함이 특징입니다. 주저하지 마시고 꾸준히 치료하면 난청·이명을 고칠 수 있습니다!
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> ms****</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard134" class="review-card" data-cat="여성질환" onclick="openReviewModal('detailModal134')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">산후풍 관절통</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2024.03</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">출산 후 아기 케어하다 온몸 관절 통증 — 아침마다 목·허리·손목·손가락 뻐근했는데 다니면서 나아지고 체질 한약까지</h3>
          <p class="review-story">
            출산 후 아기를 케어하느라 온몸 관절이 아파서 찾아간 한의원입니다. 유독 아침에 눈 뜨면 목·허리·손목·손가락 관절이 뻐근했는데 여기 다니면서 나아지는 듯했습니다. 체질에 맞는 한약도 처방해 주시고 선생님들 모두 친절해서 좋아요. 감사합니다!
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> aba****</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
          <div class="review-card-click-hint"><i class="fas fa-expand-alt"></i> 클릭하여 자세히 보기</div>
                ...
                <!-- 후기 카드 #133 -->
        <div id="reviewCard133" class="review-card" data-cat="여성질환" onclick="openReviewModal('detailModal133')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">다낭성난소증후군</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2024.03</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">다낭성난소증후군으로 피임약 먹으며 10년 가까이 생리통 — 원장님 처방 한약 먹고 엄청 많이 괜찮아졌어요!</h3>
          <p class="review-story">
            다낭성난소증후군으로 피임약을 먹으면서 생리통이 너무 심해서 10년 가까이 힘들었는데, 원장님이 처방해 주신 한약을 먹고 엄청 많이 괜찮아졌어요!! 왕왕 추천합니다!
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 나르는곰도리</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard130" class="review-card" data-cat="여성질환" onclick="openReviewModal('detailModal130')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">출산 후 손가락도 못 펼 만큼 손목이 — 정형외과 여러 번도 효과 없다가 한의원 첫 방문 단 1회 치료에 많이 호전됐어요</h3>
          <p class="review-story">
            출산 후 손목이 아파서 손가락을 아예 못 필 정도였고 정형외과를 몇 번 다녔는데도 호전이 없었습니다. 주변 추천으로 한의원에 태어나서 처음 가봤는데, 손목이 아픈데 목까지 치료해 주신다길래 처음엔 의아했지만 한 번 치료에 많이 호전되었습니다. 간호사·원장님 모두 친절하고 치료도 잘해주세요. 추천합니다!
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 또찡</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard127" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal127')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">조깅 중 무릎 뚝 — 통증의학과·정형외과 효과 없어 마지막으로 왔는데, 매선·약침으로 몇 주 만에 움직임 편해졌어요</h3>
          <p class="review-story">
            조깅 후 스트레칭 중 무릎이 뚝 소리가 나면서 5분간 그 자리에서 못 움직였습니다. 이후 통증의학과·정형외과를 다녔지만 효과를 보지 못했고, 마지막으로 이곳에 오게 되었습니다. 매선·약침치료로 몇 주째 치료를 받고 있는데 움직임이 많이 편하고 좋아졌습니다. 강추합니다!
          </p>
          <div class="review-card-footer">
        ...
        <div id="reviewCard123" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal123')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">악관절(턱관절)</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2022.12</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">턱 소리·덜컹거림으로 매주 치료 받았더니 — 이제 턱에서 소리가 안 나서 편안하고 거의 완치라고 봐도 될 것 같아요</h3>
          <p class="review-story">
            이제 턱에서 소리가 안 나서 너무 편안합니다. 덜컹거리는 게 사라졌어요. 특별한 일 없으면 매주 가서 치료를 받았는데 거의 완치라고 봐도 좋을 것 같아요.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> Hercule</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
          <div class="review-card-click-hint"><i class="fas fa-expand-alt"></i> 클릭하여 자세히 보기</div>
                ...
                <!-- 후기 카드 #122 -->
        <div id="reviewCard122" class="review-card" data-cat="척추관절" onclick="openReviewModal('detailModal122')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">어깨 회전근파열</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2022.09</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">팔 올리기도 힘들고 밤새 통증이 극심했던 어깨 회전근파열 — 약침·매선 치료 후 통증 사라지고 금방 좋아졌어요</h3>
          <p class="review-story">
            어깨 회전근 파열로 팔 올리기도 힘들고 밤새 통증이 심해져서 치료를 받고 있는데 약침과 매선치료 후 통증이 사라지고 팔 올리는 것도 금방 좋아졌습니다. 역시 소문대로 명의십니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 환상샘0</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard119" class="review-card" data-cat="여성질환" onclick="openReviewModal('detailModal119')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">다낭성난소증후군·두통·어깨통증</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2022.06</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">다낭성난소증후군·두통·어깨통증으로 방문 — 꾸준한 치료로 통증 거의 사라지고, 호르몬제 없이도 생리 주기 규칙적으로</h3>
          <p class="review-story">
            두통과 어깨 통증, 다낭성난소증후군으로 방문해 꾸준히 다니고 있습니다. 치료를 받다 보니 통증도 거의 없어졌고 생리도 밀리지 않고 잘 하고 있어서 너무 좋아요. 호르몬제 복용하면서 주기 맞췄던 때보다 더 건강하게 지내고 있습니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 21t****</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard112" class="review-card" data-cat="뇌신경" onclick="openReviewModal('detailModal112')" style="cursor:pointer;">
          <div class="review-card-header">
            <span class="review-cat-tag">귀먹먹함(이충만감)·이관개방증</span>
            <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
            <span class="review-date">2022.03</span>
          </div>
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">피로감·무기력증에 귀 먹먹함까지 — 침 치료로 피로감 사라지고 활력 생겨, 특수추나 몇 번에 이충만감도 없어졌어요</h3>
          <p class="review-story">
            피로감과 무기력증이 있었는데 침 맞고 난 뒤 피로감이 없어지고 활력이 생겼습니다. 귀가 먹먹한 느낌이 있었는데 특수추나 몇 번 받으면서 없어졌습니다. 직원분들도 친절하게 안내해주셔서 감사합니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> With하느</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
        ...
        <div id="reviewCard98" class="review-card" data-cat="뇌신경" onclick="openReviewModal('detailModal98')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">15년 척추측만증·목디스크 치료 중 찾아온 편두통·두피통증 — 4개월 만에 깨끗이 없어지고 목·허리·무릎까지 좋아졌어요</h3>
          <p class="review-story">
            15년간 척추측만증·목디스크로 정형외과 치료를 받던 중, 4개월 전 갑자기 시작된 두피통증·편두통·팔저림. 지인 소개로 수정한의원 방문, 첫날부터 통증 감소. 토양체질 한약·약침·추나로 4개월 만에 편두통·두피통증 완전 소실, 목·허리·무릎 통증도 크게 호전.
          </p>
          <div class="review-card-footer">
        ...
        <div id="reviewCard96" class="review-card review-card-handwritten" data-cat="구안와사" onclick="openReviewModal('detailModal96')" style="cursor:pointer;">
          ...
          <div class="review-quote-mark">"</div>
          <h3 class="review-card-title">벨마비 진단 후 한 달 — 한약·약침·전침·추나로 눈물·눈 감기기·입술 모양까지 거의 완전 회복됐어요</h3>
          <p class="review-story">
            25년 5월 구안와사로 얼굴 마비, 오른쪽 눈 안 감기고 눈물 지속, 음식 흘리는 불편. 조카 권유로 수정한의원 방문. 한약·약침·전침·추나 치료 후 다음날부터 묵직한 느낌 해소, 한 달 만에 눈물·눈 감기기·입술 동그라미·음식 씹기 모두 정상 회복. 정신적 스트레스도 극복했습니다.
          </p>
          <div class="review-card-footer">
            <span class="review-author"><i class="fas fa-user"></i> 유*봉 (만 67세, 남)</span>
            <div class="review-stars">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
          </div>
  ...
  <!-- 상세 모달 #182 (네이버후기) -->
  <div id="detailModal182" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal182')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추·관절</span>
        <span class="review-detail-tag">#허리디스크 #약침 #추나 #물리치료</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-detail-date">2026.04.27 · 2번째 방문 · 영수증</span>
      </div>
      <h2 class="review-detail-title">허리디스크 — 약침·추나·물리치료로 금방 치료된 것 같아요, 허리 안 좋으신 분 꼭 내원해보세요</h2>
      <img src="/static/reviews/review-182-soreugii-naver.jpg" alt="소르기이 경기의정부 허리디스크 네이버 후기" class="review-detail-img" onclick="openImgFull(this.src)" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
          <p>허리 디스크 때문에 내원했는데 진료와 치료를 잘해주셔서 금방 치료가 된 것 같아요.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-heartbeat"></i> 치료 &amp; 개선</h4>
          <p>치료는 약침과 물리치료 추나로 받았습니다. 허리 안좋으신 분 내원하셔서 치료 받아보세요ㅎ</p>
        </div>
      </div>
      <div class="review-detail-footer">
        <span class="review-author"><i class="fas fa-user"></i> 소르기이 경기의정부</span>
  ...
  <div id="detailModal169" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal169')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#테니스엘보우</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-detail-date">2026.03.11 · 1번째 방문 · 영수증</span>
      </div>
      <h2 class="review-detail-title">왼쪽 팔꿈치 테니스 엘보우 — 체질 맞춤 한약·침 병행으로 일상생활 불편함이 많이 호전됐어요</h2>
      <img src="/static/reviews/review-169-yuribada1-naver.jpg" alt="유리바다1 테니스 엘보우 네이버 후기" class="review-detail-img" onclick="openImgFull(this.src)" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
          <p>왼쪽 팔꿈치 알보로 인해 일상생활이 불편하여 수정한의원을 방문하게 되었습니다. 예약 후 이용 시 대기 시간이 바로 입장 가능할 정도로 편리했습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-heartbeat"></i> 치료 &amp; 개선</h4>
          <p>8체질 의학을 접하게 되었고 체질에 맞는 한약을 먹으며 침치료, 약침을 병행하여 현재 상태가 많이 호전되었어요. 원장님과 간호사님들이 친절하게 대해주셔서 좋은 치료가 되었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-star"></i> 총평</h4>
          <p>감사합니다. 늘 좋은 의술 펼치시기를 기원합니다.</p>
        </div>
      </div>
      <div class="review-detail-footer">
        <span class="review-author"><i class="fas fa-user"></i> 유리바다1</span>
  ...
  <div id="detailModal166" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal166')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#척추측만증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-detail-date">2026.01.16 · 1번째 방문 · 영수증</span>
      </div>
      <h2 class="review-detail-title">어려서부터 척추측만증·요통·어깨통증 — 추나·약침 후 잠깐의 치료에도 머리가 맑아지고 통증이 사라져서 놀랐어요</h2>
      <img src="/static/reviews/review-166-denicass-naver.jpg" alt="데니카쓰 척추측만증 네이버 후기" class="review-detail-img" onclick="openImgFull(this.src)" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
          <p>어려서부터 척추 측만증이 심해 잦은 요통과 어깨 통증이 있었습니다. 원장님께서는 제 몸 상태와 통증의 원인을 잘 설명해주시고, 추나, 약침까지 손수 놓아주셨어요.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-heartbeat"></i> 치료 &amp; 개선</h4>
          <p>잠깐의 치료에도 머리가 맑아지고 통증이 사라져서 놀랐네요. 미루던 치료를 지속적으로 다녀보려고 합니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-star"></i> 총평</h4>
          <p>시설도 최고입니다! 원장님부터 간호사 선생님들까지 너무 친절하시고 감사해요.</p>
        </div>
      </div>
      <div class="review-detail-footer">
        <span class="review-author"><i class="fas fa-user"></i> 데니카쓰 (남)</span>
  ...
  <div id="detailModal164" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      ...
      <img src="/static/reviews/review-164-boo-naver.jpg" alt="심*옥 류마티스관절염 네이버 후기" class="review-detail-img" onclick="openImgFull(this.src)" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
  ...
  <div id="detailModal157" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #156 -->
  <div id="detailModal156" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal156')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#흉곽출구증후군</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-detail-date">2025.07.23 · 2번째 방문 · 영수증</span>
      </div>
      <h2 class="review-detail-title">흉곽출구증후군으로 팔 통증이 심각했는데 — 태반약침·체질침으로 호전, 체질 알고 식이요법까지 챙길 수 있어요</h2>
      <img src="/static/reviews/review-156-kimeunsol-p1.jpg" alt="김은별팀장 흉곽출구증후군 후기" class="review-detail-img" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
          <p>흉곽출구증후군으로 팔의 통증이 너무 심각해서 수정한의원을 찾게 됐어요. 현재 여섯 번째 침치료를 받고 있으며 많이 호전되고 있습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-heartbeat"></i> 치료 &amp; 개선</h4>
          <p>약침이 태반약침이라 효과가 더 있는 느낌이고, 사각근에 맞고 있어요. 일단 통증이 완화되니 살 것 같습니다. 특히 좋은 점은 체질을 알게 돼 식이요법이 더 철저하게 진행될 수 있다는 것과, 체질침을 맞으면서 체질 개선까지 이루어지고 있다는 점이에요.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-star"></i> 총평</h4>
          <p>가족 모두에게 적극적으로 추천하고 있는 중입니다. 원장님께 정말 감사드려요~^^</p>
        </div>
      </div>
      <div class="review-detail-footer">
        <span class="review-author"><i class="fas fa-user"></i> 김은별팀장</span>
    ...
    <!-- 상세 모달 #155 -->
  <div id="detailModal155" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal155')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#허리통증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-detail-date">2025.07.09 · 1번째 방문 · 영수증</span>
      </div>
      <h2 class="review-detail-title">허리 통증으로 앉거나 걷기 힘들었는데 — 교정 치료 후 많이 나아지고, 매번 꼼꼼히 확인해주셔서 편안하게 치료받았어요</h2>
      <img src="/static/reviews/review-155-leejungwon-p1.jpg" alt="이정원707 허리통증 후기" class="review-detail-img" loading="lazy">
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-door-open"></i> 내원 계기</h4>
          <p>허리 통증 때문에 앉아 있거나 걷는 게 힘들었어요. 예약 후 이용했으며 대기 시간 없이 바로 입장할 수 있었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-heartbeat"></i> 치료 &amp; 개선</h4>
          <p>교정 치료를 받은 후 허리 통증이 많이 나아졌어요. 매번 올 때마다 불편한 점은 없는지, 많이 나아졌는지 꼼꼼히 확인해주신 덕분에 편안하게 치료받을 수 있었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4 class="review-detail-section-title"><i class="fas fa-star"></i> 총평</h4>
          <p>치료 효과도 좋고 세심하게 살펴봐 주시는 선생님 덕분에 안심하고 치료를 이어갈 수 있었어요. 허리 통증으로 고민하시는 분들께 추천드립니다!</p>
        </div>
      </div>
      <div class="review-detail-footer">
        <span class="review-author"><i class="fas fa-user"></i> 이정원707</span>
  ...
  <div id="detailModal154" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #153 -->
  <div id="detailModal153" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal153')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#디스크성어깨통증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2025년 5월</span>
      </div>
      <h2 class="review-detail-title">한 달간 왼쪽 어깨·팔뚝 통증 — 첫날 물리치료·침·추나로 드라마틱한 효과를 바로 느꼈어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-153-jochan-p1.jpg" alt="조찬형50 디스크성 어깨통증 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 조찬형50</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2025년 5월 28일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 내원 계기</h4>
          <p>한 달 전부터 왼쪽어깨 팔뚝이 아파서 정형외과도 다녀보고 약도 먹어보고 했습니다. 우연히 수정한의원을 알게 되었고 오늘 원장님 상담 후 물리치료 침치료 추나치료를 받았습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>드라마틱하게 정말 효과가 바로 있었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>총평</h4>
          <p>원장님 설명도 잘해주시고 직원분들도 친절하시고 감사합니다^^굿</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal149" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #148 -->
  <div id="detailModal148" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal148')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#일자목 #경추통증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2025년 2월</span>
      </div>
      <h2 class="review-detail-title">일자목 1년 고생 — 첫날 단 한 번의 치료로 효과 느껴 내일 또 치료 예정이에요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-148-ekmgg-p1.jpg" alt="ekmgg 일자목 경추통증 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> ekmgg</span>
      ...
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>일자목으로 일년 정도 불편하게 지내던중에 가족의 소개로 내원하게 됐습니다. 쇼파에 앉아 티비 보고 무거운것 조금만 들어도 목이 불편했습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>당일 내원 후 한번의 치료로 효과를 느끼니 너무 좋고 내일 또 치료 예정입니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal142" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #141 -->
  <div id="detailModal141" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal141')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-digest">소화기</span>
        <span class="review-cat-tag review-cat-tag-skin">피부아토피</span>
        <span class="review-detail-tag">#위경련 #피부발진</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2024년 8월</span>
      </div>
      <h2 class="review-detail-title">위경련·피부 발진으로 고생 — 약침·한약·팔체질 식사로 속이 편안해지고 증상 호전됐어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-141-sw-p1.jpg" alt="sw**** 위경련 피부발진 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> sw****</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2024년 8월 16일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      ...
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>위경련과 피부 발진으로 고생하여, 지인 소개로 수정한의원에 오게 됐습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>꾸준하게 약침과 한약을 먹으며 치료 받으니 속이 편안하고 증상이 호전되었습니다. 팔체질 식사로 건강해졌습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>총평</h4>
          <p>친절한 원장님과 선생님들께 감사드려요!</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal140" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #139 -->
  <div id="detailModal139" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal139')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-neuro">뇌신경</span>
      ...
      <h2 class="review-detail-title">돌발성 난청·이명으로 일상이 무너졌는데 — 원장님의 꾸준한 치료로 기적같이 완치, 이명도 고칠 수 있습니다!</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-139-ms-p1.jpg" alt="ms**** 돌발성난청 이명 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> ms****</span>
      ...
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>돌발성 난청 이명으로 일상생활이 어려울 정도로 힘들었습니다. 이명은 참기가 어려운 고통스러운 일입니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>수정한의원 원장님의 치료로 기적같이 완치가 되었습니다. 주변에 이명으로 고생하시는 분들을 보는데 양약으로 안 되는 경우를 종종 봅니다. 역시 수정한의원은 다릅니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원의 특징</h4>
          <p>원장님의 지극한 정성과 연구, 간호사들의 친절함, 가족과 같이 대해주는 것이 수정한의원의 특징입니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>이명으로 고생하시는 분들께</h4>
          <p>주저하지 마시고 용기를 내어 수정한의원 원장님을 신뢰하며 꾸준히 치료하면 난청·이명을 고칠 수 있습니다. 제가 너무 기쁘고 행복하기에 이 글을 통해 감사의 마음을 나누고 싶었습니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal135" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #134 -->
  <div id="detailModal134" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal134')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-women">여성질환</span>
        <span class="review-detail-tag">#산후풍 #관절통</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2024년 3월</span>
      </div>
      <h2 class="review-detail-title">출산 후 아기 케어하다 온몸 관절 통증 — 아침마다 목·허리·손목·손가락 뻐근했는데 다니면서 나아지고 체질 한약까지</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-134-aba-p1.jpg" alt="aba**** 산후풍 관절통 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> aba****</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2024년 3월 16일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>출산 후 아기를 케어하느라 온몸의 관절이 아파서 찾아간 한의원입니다. 유독 아침에 눈을 뜨면 목·허리·손목·손가락 관절이 뻐근하니 아팠습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>여기 다니면서 나아지는 듯했습니다. 체질한의원이라 체질에 맞는 한약도 처방해 주셨습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원에 전하는 말</h4>
          <p>선생님들 모두 친절하니 좋아요. 감사합니다^^</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <!-- 상세 모달 #133 -->
  <div id="detailModal133" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal133')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-women">여성질환</span>
      ...
      <h2 class="review-detail-title">다낭성난소증후군으로 피임약 먹으며 10년 가까이 생리통 — 원장님 처방 한약 먹고 엄청 많이 괜찮아졌어요!</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-133-nareun-p1.jpg" alt="나르는곰도리 다낭성난소증후군·생리통 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 나르는곰도리</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2024년 3월 6일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        ...
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>다낭성난소증후군으로 피임약을 먹으면서 생리통이 너무 심해서 10년 가까이 힘들었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>원장님이 처방해 주신 한약을 먹고 엄청 많이 괜찮아졌습니다. 왕왕 추천합니다!!</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal131" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #130 -->
  <div id="detailModal130" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal130')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-women">여성질환</span>
        <span class="review-detail-tag">#산후풍 #관절통</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
      ...
      <h2 class="review-detail-title">출산 후 손가락도 못 펼 만큼 손목이 — 정형외과 여러 번도 효과 없다가 한의원 첫 방문 단 1회 치료에 많이 호전됐어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-130-ttojjing-p1.jpg" alt="또찡 산후풍 관절통 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 또찡</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2023년 12월 18일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>출산 후 손목이 아파서 손가락을 아예 못 필 정도였습니다. 정형외과를 몇 번 다녔는데도 호전이 없었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료를 받게 된 이유</h4>
          <p>주변 추천으로 한의원에 태어나서 처음 가봤습니다. 손목이 아픈데 목까지 치료를 해주신다길래 처음엔 의아했습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>치료 받고 나니까 한 번인데도 많이 호전되었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원에 전하는 말</h4>
          <p>간호사분들도 다 친절하시고 원장님도 친절하시고 치료도 잘해주세요. 추천합니다!</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal128" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #127 -->
  <div id="detailModal127" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal127')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
  ...
  <div id="detailModal124" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #123 -->
  <div id="detailModal123" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal123')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#악관절 #턱관절</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2022년 12월</span>
      </div>
      <h2 class="review-detail-title">턱 소리·덜컹거림으로 매주 치료 받았더니 — 이제 턱에서 소리가 안 나서 편안하고 거의 완치라고 봐도 될 것 같아요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-123-hercule-p1.jpg" alt="Hercule 악관절 턱관절 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> Hercule</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2022년 12월 24일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>턱에서 소리가 나고 덜컹거리는 증상으로 수정한의원에서 치료를 받았습니다. 특별한 일이 없으면 매주 방문해 치료를 받았습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>이제 턱에서 소리가 안 나서 너무 편안합니다. 덜컹거리는 게 사라졌어요. 거의 완치라고 봐도 좋을 것 같아요.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <!-- 상세 모달 #122 -->
  <div id="detailModal122" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal122')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-spine">척추관절</span>
        <span class="review-detail-tag">#어깨회전근파열</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2022년 9월</span>
      </div>
      <h2 class="review-detail-title">팔 올리기도 힘들고 밤새 통증이 극심했던 어깨 회전근파열 — 약침·매선 치료 후 통증 사라지고 금방 좋아졌어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-122-hwansang-p1.jpg" alt="환상샘0 어깨 회전근파열 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 환상샘0</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2022년 9월 6일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>어깨 회전근 파열로 팔 올리기도 힘들고 밤새 통증이 심해져서 치료를 받고 있습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>약침과 매선 치료 후 통증이 사라지고 팔 올리는 것도 금방 좋아졌습니다. 역시 소문대로 명의십니다. ^*^~</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal120" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #119 -->
  <div id="detailModal119" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal119')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-women">여성질환</span>
        <span class="review-detail-tag">#다낭성난소증후군 #두통 #어깨통증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2022년 6월</span>
      </div>
      <h2 class="review-detail-title">다낭성난소증후군·두통·어깨통증으로 방문 — 꾸준한 치료로 통증 거의 사라지고, 호르몬제 없이도 생리 주기 규칙적으로</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-119-21t-p1.jpg" alt="21t**** 다낭성난소증후군·두통·어깨통증 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 21t****</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2022년 6월 30일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>두통과 어깨 통증, 다낭성난소증후군으로 수정한의원을 방문해 꾸준히 다니고 있습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>꾸준히 치료를 받다 보니 통증도 거의 없어졌고, 생리도 밀리지 않고 잘 하고 있어서 너무 좋아요. 호르몬제 복용하면서 주기 맞췄던 때보다 더 건강하게 지내고 있습니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal113" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    ...
    <!-- 상세 모달 #112 -->
  <div id="detailModal112" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      <button class="review-detail-close" onclick="closeModalById('detailModal112')">✕ 닫기</button>
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-neuro">자율신경·뇌신경</span>
        <span class="review-detail-tag">#귀먹먹함(이충만감) #이관개방증</span>
        <span class="review-naver-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2022년 3월</span>
      </div>
      <h2 class="review-detail-title">피로감·무기력증에 귀 먹먹함까지 — 침 치료로 피로감 사라지고 활력 생겨, 특수추나 몇 번에 이충만감도 없어졌어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-112-withhaneu-p1.jpg" alt="With하느 귀먹먹함·이관개방증 네이버후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> With하느</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2022년 3월 26일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>피로감과 무기력증이 있었는데 이 곳에서 침 맞고 난뒤에 피로감도 없어지고 활력이 생겼습니다. 또 귀가 먹먹한 느낌이 있었는데 특수추나 몇번 받으면서 없어졌습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원에 전하는 말</h4>
          <p>직원분들도 친절하게 안내해주셔서 감사합니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal98" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      ...
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-neuro">자율신경·뇌신경</span>
        <span class="review-detail-tag">#편두통 #두피통증 #척추측만증</span>
        <span class="review-handwritten-badge"><i class="fas fa-pen-nib"></i> 네이버후기</span>
        <span class="review-date">2025년 11월</span>
      </div>
      <h2 class="review-detail-title">15년 척추측만증·목디스크로 무릎·허리·목 치료를 받던 중 — 4개월 전 시작된 편두통·두피통증·팔저림이 4개월 치료로 깨끗이 없어졌어요</h2>
      <div class="review-detail-image-wrap">
      ...
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>약 15년 전부터 정형외과에서 척추측만증과 목디스크로 목·허리·무릎 통증 치료를 받아왔습니다. 4개월 전에 갑자기 머리 전체가 찌릇찌릇한 두피통증과 편두통, 팔저림 때문에 고통을 받다가 지인의 소개로 수정한의원을 오게 되었습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>첫날 치료 후 극심했던 통증이 많이 감소했습니다. 심장의 열을 내리는 한약과 약침·추나치료를 하면서 토양체질에 해가 되는 음식을 절제했습니다. 4개월 정도 치료 후 편두통과 두피통증은 깨끗이 없어지고, 전에 아팠던 목·허리·무릎 통증도 많이 좋아졌습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>삶의 질 변화</h4>
          <p>우선 통증이 없으니 마음이 편하고, 또 원장님과 세 분의 간호사님의 친절에 한의원에 올 때마다 기뻤습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원에 전하는 말</h4>
          <p>감사드립니다. 혹시 몸이 불편하신 분들은 일단 수정한의원에 한번 오셔서 원장님의 상담 받아보시길 추천합니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="detailModal96" class="review-detail-modal" onclick="closeReviewModal(event,this)" style="display:none;">
    <div class="review-detail-inner">
      ...
      <div class="review-detail-header">
        <span class="review-cat-tag review-cat-tag-special">구안와사·안면마비</span>
        <span class="review-detail-tag">#구안와사 #안면마비 #벨마비</span>
        <span class="review-special-badge"><i class="fas fa-star"></i> 특설클리닉</span>
        <span class="review-handwritten-badge"><i class="fas fa-pen-nib"></i> 자필후기</span>
        <span class="review-date">2025년 6월</span>
      </div>
      <h2 class="review-detail-title">벨마비 진단 후 한 달 — 한약·약침·전침·추나로 눈물·눈 감기기·입술 모양까지 거의 완전 회복됐어요</h2>
      <div class="review-detail-image-wrap">
        <img src="/static/reviews/review-96-yuhakbong-p1.jpg" alt="유*봉 구안와사·안면마비 자필후기" class="review-detail-image" loading="lazy">
      </div>
      <div class="review-detail-author">
        <span><i class="fas fa-user"></i> 유*봉 (만 67세, 남)</span>
        <span><i class="fas fa-calendar"></i> 작성일: 2025년 6월 24일</span>
      </div>
      <div class="review-detail-stars">
        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
      </div>
      <div class="review-detail-content">
        <div class="review-detail-section">
          <h4>증상 및 불편함</h4>
          <p>25년 5월 26일 구안와사로 얼굴이 마비되고 오른쪽으로 음식물이 흘러서 백병원 응급실에 방문했습니다. 피검사, 소변검사, CT, MRI를 찍고 '벨마비'라고 진단을 받았습니다. 오른쪽 눈이 안 감기고 눈물이 계속 나고, 입이 잘 벌어지지 않고 음식이 잘 씹어지지 않아 흘리게 되어 많이 불편했습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료를 받게 된 이유</h4>
          <p>조카가 강력하게 수정한의원에 가라고 해서 오게 됐습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>치료 및 개선 사항</h4>
          <p>한약과 약침, 전침, 추나 치료를 받았습니다. 침 맞은 다음날부터 묵직한 느낌이 사라졌고, 한 달 다 되어 가는데 지금 거의 다 좋아졌습니다.</p>
          <p>제일 불편하던 눈물 나는 것은 벌써 없어졌고, 음식 씹는 것도 괜찮고, 이마와 눈도 잘 감기고 힘이 거의 다 들어갑니다. 입술 모양도 동그라미가 잘 되고 일상생활에서 아무런 불편함이 없습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>삶의 질 변화</h4>
          <p>치료받으면서 원장님이 참 편했습니다. 구안와사와 개인적인 사정으로 정신적으로도 많이 힘들었는데, 얼굴이 원래대로 돌아오면서 스트레스를 이겨내는 데 도움이 됐습니다.</p>
        </div>
        <div class="review-detail-section">
          <h4>수정한의원에 전하는 말</h4>
          <p>감사하다는 말을 드리고 싶습니다. 안면마비 환자들에게 망설이지 말고 빨리 와야 한다고 말해주고 싶습니다.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var CARDS = [
      ...
      { el: document.getElementById('reviewCard07'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard21'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard107'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard106'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard105'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard104'), cat: '척추관절' },
      { el: document.getElementById('reviewCard103'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard98'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard91'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard74'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard70'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard66'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard65'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard61'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard46'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard45'), cat: '척추관절' },
      { el: document.getElementById('reviewCard44'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard43'), cat: ['뇌신경', '편두통'] },
      ...
      { el: document.getElementById('reviewCard36'), cat: ['뇌신경', '편두통'] },
      { el: document.getElementById('reviewCard35'), cat: ['뇌신경', '편두통'] },
    ...
    document.querySelectorAll('.review-filter-btn').forEach(function(btn) {
      btn.addEventListener('click', function() {
        ...
        CARDS.forEach(function(item) {
          if (!item.el) return;
          if (cat === 'all' || (Array.isArray(item.cat) ? item.cat.includes(cat) : item.cat === cat)) {
