export const clinic_digestionPage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>소화기 클리닉 | 만성소화불량·역류성식도염·과민성대장·췌장염 – 수정한의원</title>
  <meta name="description" content="만성소화불량, 역류성식도염·위식도역류, 과민성대장증후군, 만성변비·설사, 췌장염. 양방 치료 후에도 재발하는 소화기 질환, 8체질 맞춤 한방치료로 근본 개선. 노원구 한의원."/>
  ...
  <link rel="canonical" href="https://www.8chejil-sujeong.com/clinic/digestion"/>

  <!-- Open Graph -->
  <meta property="og:title" content="소화기 클리닉 | 만성소화불량·역류성식도염·과민성대장·췌장염 – 수정한의원"/>
  <meta property="og:description" content="만성소화불량, 역류성식도염·위식도역류, 과민성대장증후군, 만성변비·설사, 췌장염. 양방 치료 후에도 재발하는 소화기 질환, 8체질 맞춤 한방치료로 근본 개선. 노원구 한의원."/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/clinic/digestion"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="소화기 클리닉 | 만성소화불량·역류성식도염·과민성대장·췌장염 – 수정한의원"/>
  <meta name="twitter:description" content="만성소화불량, 역류성식도염·위식도역류, 과민성대장증후군, 만성변비·설사, 췌장염. 양방 치료 후에도 재발하는 소화기 질환, 8체질 맞춤 한방치료로 근본 개선. 노원구 한의원."/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"소화기 클리닉","item":"https://8chejil-sujeong.com/clinic/digestion"}]},{"@type":"MedicalCondition","name":"만성소화불량"},{"@type":"MedicalCondition","name":"역류성식도염·위식도역류"},{"@type":"MedicalCondition","name":"과민성대장증후군"},{"@type":"MedicalCondition","name":"만성변비·설사"},{"@type":"MedicalCondition","name":"췌장염"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 소화기질환 클리닉</div>
    <h1>소화기질환 클리닉</h1>
    <p>체질에 맞는 근본 치료로 속이 편안한 변화를 경험하세요</p>
  </div>
</section>
<section class="clinic-intro bg-cream">
  <div class="section-container">
    <div class="clinic-intro-badge"><i class="fas fa-stomach"></i> 소화기질환 클리닉</div>

    <div class="auto-wrap">

      <!-- Hero -->
      <div class="auto-hero-box" style="background: linear-gradient(135deg, #0d2b1a 0%, #1a5c35 100%);">
        <div class="auto-hero-main">위장이 보내는 신호,<br/>몸 전체가 받고 있습니다.</div>
        <div class="auto-hero-sub">소화불량, 역류, 복통, 설사, 변비 — 같은 증상이라도 체질이 다르면 원인이 다릅니다.<br/>수정한의원은 8체질 진단으로 <strong style="color:#a8ffd0;">'나만의 소화기 치료'</strong>를 설계합니다.</div>
      </div>

      <!-- 질환표 -->
      <div class="auto-q-block">
        <div class="auto-q-title auto-treat-title" style="background:#f0f7f2; color:#1a3d28; border-color:#b8d4be;">
          <span class="auto-qnum auto-qnum-green"><i class="fas fa-list" style="font-size:0.75rem;"></i></span>
          <span>이런 소화기 질환을 치료합니다</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr><td class="att-label">만성 소화불량</td><td>식후 더부룩함, 조기 포만감, 가스, 속 쓰림이 반복</td></tr>
                <tr><td class="att-label">식도염·역류성 식도염</td><td>식후 가슴·목 작열감, 신물, 마른기침, 목 이물감</td></tr>
                <tr><td class="att-label">과민성 대장 증후군</td><td>스트레스 시 복통·설사·변비 교대, 잦은 화장실</td></tr>
                <tr><td class="att-label">만성 변비·설사</td><td>장 연동운동 저하(변비) 또는 과항진(설사)이 지속</td></tr>
                <tr><td class="att-label">췌장염</td><td>명치·복부 심한 통증, 소화효소 저하, 혈당 조절 이상</td></tr>
                <tr><td class="att-label">궤양성 대장염</td><td>혈변·점액변, 복통 반복, 면역 이상에 의한 난치성 장 질환</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>소화기 질환이 전신 증상까지 일으키는 이유는?</span>
        </div>
        <div class="auto-q-body">
          <p>위장은 독립된 장기가 아닙니다. <strong>제10뇌신경인 미주신경(Vagus Nerve)</strong>이 뇌간에서 출발하여 식도·위·소장·대장·간·췌장까지 직접 연결하고 있으며, 소화 운동·위산 분비·장 면역·염증 조절을 실시간으로 관장합니다. 미주신경의 기능이 저하되거나 과항진되면 소화 증상뿐 아니라 두통, 만성 피로, 불면, 불안감, 심박 이상까지 동반됩니다.</p>
          <div class="auto-highlight-box"><strong>핵심:</strong> 소화기 질환을 근본적으로 치료하려면, 위장 자체뿐 아니라 위장을 지배하는 <strong>미주신경과 자율신경 경로 전체</strong>를 함께 다루어야 합니다.</div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 약을 먹어도 반복되나요?</span>
        </div>
        <div class="auto-q-body">
          <p>양방 소화기 약물(제산제, PPI, 진경제, 지사제 등)은 증상을 억제하는 데 초점이 맞춰져 있습니다. 그러나 같은 소화불량이라도 원인은 체질마다 다릅니다.</p>
          <div class="auto-constitution-list">
            <div class="auto-const-item">
              <span class="auto-const-icon">🟢</span>
              <span><strong>목양·목음체질</strong> — 간·담의 과항진이 위·췌장을 억제하여 소화력 저하(목양) 또는 대장 과민·빈변(목음)을 유발</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🟡</span>
              <span><strong>토양·토음체질</strong> — 위장·췌장이 선천적으로 강하지만, 과항진 시 오히려 위산 과다·염증이 발생</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">⚪</span>
              <span><strong>금양·금음체질</strong> — 간이 약해 해독 부담이 위·대장에 집중, 역류성 식도염·궤양성 대장염·과민성 대장 유발</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🔵</span>
              <span><strong>수양·수음체질</strong> — 위장이 선천적으로 차갑고 약해 연동운동 자체가 저하</span>
            </div>
          </div>
          <div class="auto-highlight-box">체질을 모르면 같은 약을 반복할 수밖에 없고, <strong>증상은 돌고 돕니다.</strong></div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>미주신경 치료가 왜 소화기의 핵심인가요?</span>
        </div>
        <div class="auto-q-body">
          <p>미주신경은 <strong>뇌간 → 경추 1‑2번 → 경부 → 흉부 → 복부 장기</strong>로 이어지는 인체에서 가장 긴 뇌신경입니다. 이 경로 어디에서든 기능 장애가 생기면 위장에 직접적인 영향이 발생합니다.</p>
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead>
                <tr><th>문제 부위</th><th>소화기에 미치는 영향</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td class="att-label">경추 1‑2번 변위</td>
                  <td>뇌간에서 미주신경이 출발하는 기시부가 압박·자극을 받아 위장 조절 신호 왜곡 — 위산 과다, 연동운동 이상, 소화력 저하의 숨은 원인</td>
                </tr>
                <tr>
                  <td class="att-label">턱관절(TMJ) 불균형</td>
                  <td>삼차신경·안면신경과 미주신경이 뇌간에서 교차 — 턱관절 변위 시 미주신경 긴장도에 영향, 인후 이물감·역류 증상 악화</td>
                </tr>
                <tr>
                  <td class="att-label">척추 배수혈(背兪穴) 이상</td>
                  <td>흉추·요추 척추 옆 배수혈에서 자율신경이 각 장기로 분지 — 비수·위수·간수·대장수가 해당 장기 자율신경 조절점</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="auto-highlight-box"><strong>핵심:</strong> 경추 1‑2 교정 → 미주신경 기시부 정상화 / 턱관절 교정 → 미주신경 긴장도 안정 / 배수혈 치료 → 장기별 자율신경 직접 조절. 이 세 가지가 소화기 치료의 <strong>구조적 근본</strong>입니다.</div>
        </div>
      </div>
      ...
      <div class="auto-q-block auto-treatment">
        ...
        <div class="auto-q-body">
            ...
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>30년·21,560건 데이터 기반 체질 확정 → 소화기 증상의 체질적 근본 원인 파악</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-bone"></i> 경추 1‑2 교정 추나요법</td>
                  <td>상부 경추 변위 교정으로 미주신경 기시부 압박 해소 → 뇌간→위장 신호 전달 정상화</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-teeth"></i> 턱관절(TMJ) 교정 치료</td>
                  <td>턱관절 정렬을 바로잡아 삼차신경‑미주신경 간섭 제거 → 인후 이물감·역류 악화 요인 차단</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 척추 배수혈 침 치료</td>
                  <td>비수·위수·간수·대장수 등 척추 옆 경혈 직접 자극 → 각 소화 장기의 교감·부교감 균형 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 8체질 침 치료</td>
                  <td>체질별 장부 강약에 따른 전신 장부 균형 조절</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-syringe"></i> 약침요법</td>
                  <td>한약 유효 성분을 경혈에 직접 주입 → 항염·점막 회복·자율신경 안정의 이중 효과</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-leaf"></i> 체질 맞춤 한약</td>
                  <td>과항진 장부 억제, 약화 장부 보강 → 소화 기능의 내과적 근본 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-wave-square"></i> 빔레이 파동요법</td>
                  <td>장내 유해균의 공명 주파수에 선택적 작용 → 장내 미생물 환경 정상화</td>
                </tr>
                <tr>
          ...
          <div class="auto-flow-box">
            <strong>치료 흐름:</strong> 체질 진단 → 구조 교정(경추·턱관절) → 자율신경 조절(배수혈·체질침) → 내과적 보강(약침·한약) → 장내 환경 정비(빔레이) → 체질 식이·생활 관리
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>체질 식이가 왜 중요한가요?</span>
        </div>
        <div class="auto-q-body">
          <p>8체질의학에서는 체질에 맞지 않는 음식 자체가 소화기 질환의 직접적 원인이 될 수 있다고 봅니다. 수양·수음체질에게 찬 음식·생식은 위장 기능을 더 떨어뜨리고, 토양·토음체질에게 기름진 육류 과다 섭취는 위열을 악화시킵니다.</p>
      ...
      <div class="auto-q-block">
        ...
        <div class="auto-q-body">
          <div class="auto-highlight-box" style="border-left-color:#2e7d32; background:#f1f8f3;">
            ...
            현재 복용 중인 약물(PPI, 제산제, 5‑ASA, 면역억제제, 생물학적 제제 등)을 유지하면서 체질 치료를 병행할 수 있습니다. 소화기 균형이 회복되면서 양방 약물을 점진적으로 조정해 나가는 것이 목표이며, 진료 시 현재 약물을 알려주시면 통합 치료 계획을 수립합니다.
          </div>
        </div>
      </div>
      ...
      <div class="sdi-cta-box" style="margin-top:28px;">
        <div class="sdi-cta-concerns">
          <span>"약 먹으면 괜찮다가 끊으면 다시 아파요"</span>
          <span>"소화제를 달고 살아요"</span>
          <span>"스트레스만 받으면 배가 아파요"</span>
          <span>"혈변이 반복되는데 방법이 없대요"</span>
        </div>
        <p class="sdi-cta-lead">소화기 질환은 <strong>체질 + 미주신경 + 자율신경</strong>의 문제입니다.<br/>경추 교정 · 배수혈 치료 · 8체질 통합의학으로 되풀이되는 악순환을 끊으세요.</p>
