export const clinic_skinPage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>피부·호흡기 클리닉 | 아토피·지루성피부염·비염·천식·COPD – 수정한의원</title>
  <meta name="description" content="아토피 피부염, 지루성피부염, 두드러기·건선, 비염·축농증(부비동염), COPD·기관지확장증. 스테로이드 없이 체질 맞춤 한방치료. 재발 없는 근본 치료 노원구 한의원."/>
  ...
  <!-- 검색엔진 최적화 -->
  <meta name="keywords" content="수정한의원, 노원구안와사, 노원안면마비, 노원아토피, 노원지루성피부염, 노원두드러기, 노원건선, 상계동아토피, 중계동아토피, 노원피부질환한의원, 8체질피부치료"/>
  <meta name="author" content="수정한의원"/>
  <meta name="robots" content="index, follow"/>
  <meta name="googlebot" content="index, follow"/>
  <link rel="canonical" href="https://www.8chejil-sujeong.com/clinic/skin"/>

  <!-- Open Graph -->
  <meta property="og:title" content="피부·호흡기 클리닉 | 아토피·지루성피부염·비염·천식·COPD – 수정한의원"/>
  <meta property="og:description" content="아토피 피부염, 지루성피부염, 두드러기·건선, 비염·축농증(부비동염), COPD·기관지확장증. 스테로이드 없이 체질 맞춤 한방치료. 재발 없는 근본 치료 노원구 한의원."/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/clinic/skin"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="피부·호흡기 클리닉 | 아토피·지루성피부염·비염·천식·COPD – 수정한의원"/>
  <meta name="twitter:description" content="아토피 피부염, 지루성피부염, 두드러기·건선, 비염·축농증(부비동염), COPD·기관지확장증. 스테로이드 없이 체질 맞춤 한방치료. 재발 없는 근본 치료 노원구 한의원."/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"피부·호흡기 클리닉","item":"https://8chejil-sujeong.com/clinic/skin"}]},{"@type":"MedicalCondition","name":"아토피 피부염"},{"@type":"MedicalCondition","name":"지루성피부염"},{"@type":"MedicalCondition","name":"두드러기·건선"},{"@type":"MedicalCondition","name":"비염·축농증"},{"@type":"MedicalCondition","name":"COPD·기관지확장증"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 피부·호흡기 클리닉</div>
    <h1>피부·호흡기질환 클리닉</h1>
    <p>8체질로 접근하는 근본 면역 치료</p>
  </div>
</section>

<section class="clinic-intro bg-cream">
  <div class="section-container">
    <div class="clinic-intro-badge"><i class="fas fa-hand-sparkles"></i> 피부·호흡기질환 클리닉</div>

    <div class="auto-wrap">

      <!-- Hero -->
      <div class="auto-hero-box" style="background: linear-gradient(135deg, #1a0a2e 0%, #3b1a6e 60%, #1a0a3a 100%);">
        <div class="auto-hero-main">피부와 폐는 같은 뿌리입니다.<br/>겉으로 보이는 증상, 속에서 시작됩니다.</div>
        <div class="auto-hero-sub">아토피, 건선, 두드러기, 비염, 천식, COPD — 피부와 호흡기는 면역이라는 하나의 축으로 연결되어 있습니다.<br/>수정한의원은 8체질 진단으로 <strong style="color:#d4b8ff;">면역 불균형의 근본 원인</strong>을 찾습니다.</div>
      </div>

      <!-- 질환표 -->
      <div class="auto-q-block">
        <div class="auto-q-title" style="background:#f5f0ff; color:#2d1060; border-bottom-color:#d4b8ff;">
          <span class="auto-qnum" style="background:#3b1a6e;"><i class="fas fa-list" style="font-size:0.75rem;"></i></span>
          <span>이런 피부·호흡기 질환을 치료합니다</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr><td class="att-label">아토피 피부염</td><td>반복되는 가려움·건조·진물, 스테로이드 의존, 수면 방해</td></tr>
                <tr><td class="att-label">건선</td><td>은백색 각질·붉은 반점이 반복, 스트레스 시 악화, 관절 동반 가능</td></tr>
                <tr><td class="att-label">두드러기·습진</td><td>원인 불명의 팽진·가려움이 6주 이상 반복 (만성 두드러기)</td></tr>
                <tr><td class="att-label">알레르기 비염</td><td>맑은 콧물, 재채기, 코막힘, 눈 가려움이 계절 또는 연중 지속</td></tr>
                <tr><td class="att-label">천식</td><td>기침, 쌕쌕거림, 호흡곤란이 반복, 야간·새벽 악화</td></tr>
                <tr><td class="att-label">COPD (만성폐쇄성폐질환)</td><td>만성 기침·가래, 활동 시 호흡곤란이 점진적으로 악화, 폐 기능 비가역적 저하</td></tr>
                <tr><td class="att-label">만성 기침</td><td>감기 후 기침이 4주 이상 지속, 검사상 이상 없음</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 피부 질환과 호흡기 질환을 함께 보나요?</span>
        </div>
        <div class="auto-q-body">
          <p>한의학에서 피부와 폐는 <strong>"폐주피모(肺主皮毛)"</strong> — 폐가 피부와 호흡기를 동시에 관장합니다. 실제로 아토피가 있는 아이의 상당수가 이후 비염·천식으로 이행하는 <strong>'알레르기 행진(Allergic March)'</strong>을 겪으며, 이는 피부와 호흡기가 하나의 면역 축으로 연결되어 있다는 것을 보여줍니다.</p>
          <div class="auto-highlight-box">피부만 치료하거나 호흡기만 치료해서는 재발을 막을 수 없고, <strong>면역 시스템 전체를 체질에 맞게 조율해야 합니다.</strong></div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 약을 써도 반복되나요?</span>
        </div>
        <div class="auto-q-body">
          <p>양방 치료(스테로이드, 항히스타민제, 면역억제제, 흡입제, 기관지확장제 등)는 과도한 면역 반응을 억제하거나 기도를 일시적으로 확장하는 데 초점이 맞춰져 있습니다. 그러나 면역이 왜 과잉 반응하는지, 폐 기능이 왜 저하되는지는 체질마다 다릅니다.</p>
          <div class="auto-constitution-list">
            <div class="auto-const-item">
              <span class="auto-const-icon">⚪</span>
              <span><strong>금양·금음체질</strong> — 폐·대장이 선천적으로 강하고 간이 약해, 면역 과잉 반응이 피부·호흡기에 집중 → 아토피·비염·천식의 대표 체질</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🟢</span>
              <span><strong>목양·목음체질</strong> — 폐·대장이 최약 장기로, 호흡기·피부 방어력 자체가 취약 → 감기가 잦고, 비염 만성화, COPD로 진행 시 회복이 더딤</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🟡</span>
              <span><strong>토양·토음체질</strong> — 위장 열이 피부로 발산 → 여드름·습진·두드러기 양상으로 나타남</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🔵</span>
              <span><strong>수양·수음체질</strong> — 신장·방광이 강하고 폐가 약해, 냉한 체질 특성이 호흡기 면역 저하로 이어짐</span>
            </div>
          </div>
          <div class="auto-highlight-box">체질을 모르면 같은 면역억제제·흡입제를 반복할 수밖에 없고, <strong>약을 끊으면 다시 올라옵니다.</strong></div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>미주신경·경추·배수혈이 피부·호흡기와 무슨 관계인가요?</span>
        </div>
        <div class="auto-q-body">
          <p><strong>미주신경(제10뇌신경)</strong>은 폐·기관지의 수축·이완과 기도 점막 면역을 직접 조절합니다. 또한 미주신경 활성화가 <strong>전신 염증 반응을 억제(항염 경로)</strong>하는 것으로 밝혀져, 피부 염증과도 깊이 관련됩니다.</p>
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead>
                <tr><th>문제 부위</th><th>피부·호흡기에 미치는 영향</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td class="att-label">경추 1‑2번 변위</td>
                  <td>뇌간에서 미주신경 기시부가 압박 → 항염 신호 약화 → 피부·기도 염증 만성화</td>
                </tr>
                <tr>
                  <td class="att-label">턱관절(TMJ) 불균형</td>
                  <td>삼차신경 자극 → 안면 피부 과민·비강 충혈 악화</td>
                </tr>
                <tr>
                  <td class="att-label">척추 배수혈</td>
                  <td>폐수(肺兪)·대장수(大腸兪)·간수(肝兪) 등 자율신경 분지점을 직접 자극 → 해당 장기의 면역 균형 회복</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr>
                  <td class="att-label"><i class="fas fa-search"></i> 8체질 정밀 진단</td>
                  <td>30년·21,560건 데이터 기반 체질 확정 → 면역 과잉/저하의 체질적 근본 원인 파악</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-bone"></i> 경추 1‑2 교정 추나요법</td>
                  <td>미주신경 기시부 압박 해소 → 항염 경로 정상화</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-teeth"></i> 턱관절(TMJ) 교정</td>
                  <td>삼차신경 간섭 제거 → 안면 피부·비강 과민 완화</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 척추 배수혈 침 치료</td>
                  <td>폐수·대장수·간수 등 자율신경 분지점 자극 → 장기별 면역 균형 직접 조절</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 8체질 침 치료</td>
                  <td>체질별 장부 강약에 따른 전신 면역 균형 조율</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-syringe"></i> 약침요법</td>
                  <td>한약 유효 성분을 경혈에 직접 주입 → 항염·면역 조절·피부 재생 이중 효과</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-thread"></i> 매선요법</td>
                  <td>약실을 경혈·근막에 매입 → 지속적 자극으로 면역 안정 효과 연장</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-leaf"></i> 체질 맞춤 한약</td>
                  <td>과항진 장부 억제, 약화 장부(특히 폐) 보강 → 면역 균형의 내과적 근본 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-wave-square"></i> 빔레이 파동요법</td>
                  <td>저에너지 전자기장으로 기도·폐 내 염증 환경 개선, 면역 세포 활성 보조</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-circle-dot"></i> 양자돔 + 생활관리</td>
                  <td>전신 이완·면역 회복, 체질별 식이 지도</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="auto-flow-box">
            <strong>치료 흐름:</strong> 체질 진단 → 구조 교정(경추·턱관절) → 면역 조절(배수혈·체질침·약침·매선) → 내과적 보강(한약) → 염증 환경 정비(빔레이) → 체질 식이·생활 관리
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>체질 식이가 피부·호흡기에 왜 중요한가요?</span>
        </div>
        <div class="auto-q-body">
          <p>8체질의학에서는 체질에 맞지 않는 음식 자체가 면역 과잉의 직접적 방아쇠가 될 수 있다고 봅니다. 금양·금음체질이 육류·유제품을 과다 섭취하면 비염·아토피가 악화되고, 목양·목음체질이 해물·생채소를 과다 섭취하면 이미 약한 폐·대장이 더 약해져 피부·호흡기 방어력이 떨어집니다.</p>
          <div class="auto-stat-box">
            <span class="auto-stat-icon">📋</span>
            <span>수정한의원은 체질 확정 후 <strong>개인별 식이표를 제공</strong>하여 치료 효과를 극대화하고 재발을 방지합니다.</span>
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        ...
        <div class="auto-q-body">
          <div class="auto-highlight-box" style="border-left-color:#2e7d32; background:#f1f8f3;">
            ...
            현재 사용 중인 스테로이드 연고·흡입제, 항히스타민제, 기관지확장제, 면역억제제, 생물학적 제제 등을 유지하면서 체질 치료를 병행할 수 있습니다. 특히 COPD 환자의 경우 기존 흡입제를 유지하면서 체질 치료로 잔존 폐 기능 보존·염증 진행 억제·호흡 근력 회복을 병행하는 것이 목표입니다. 진료 시 현재 치료 상황을 알려주시면 통합 계획을 수립합니다.
          </div>
        </div>
      </div>
      ...
      <div class="sdi-cta-box" style="margin-top:28px;">
        <div class="sdi-cta-concerns">
          <span>"스테로이드 끊으면 바로 올라와요"</span>
          <span>"비염약 없이는 하루도 못 버텨요"</span>
          <span>"아이 아토피가 천식으로 번지고 있어요"</span>
          <span>"계단만 올라가도 숨이 차요"</span>
          <span>"COPD 진단 받았는데 흡입제만으로는 불안해요"</span>
        </div>
        <p class="sdi-cta-lead">피부·호흡기 질환은 면역의 문제이고, <strong>면역은 체질의 문제</strong>입니다.<br/>8체질 정밀 진단 + 구조 교정 + 면역 통합 치료로 되풀이되는 악순환을 끊으세요.</p>
