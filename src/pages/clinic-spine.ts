export const clinic_spinePage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>척추·관절 클리닉 | 허리디스크·척추관협착증·무릎관절염·오십견 – 수정한의원</title>
  <meta name="description" content="허리디스크(추간판탈출증), 척추관협착증, 무릎관절염, 오십견·회전근개 손상. 수술 없이 8체질 침치료·추나·한약으로 통증 근본 해소. 노원구 한의원. ☎ 02-932-3815"/>
  ...
  <link rel="canonical" href="https://www.8chejil-sujeong.com/clinic/spine"/>

  <!-- Open Graph -->
  <meta property="og:title" content="척추·관절 클리닉 | 허리디스크·척추관협착증·무릎관절염·오십견 – 수정한의원"/>
  <meta property="og:description" content="허리디스크(추간판탈출증), 척추관협착증, 무릎관절염, 오십견·회전근개 손상. 수술 없이 8체질 침치료·추나·한약으로 통증 근본 해소. 노원구 한의원. ☎ 02-932-3815"/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/clinic/spine"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="척추·관절 클리닉 | 허리디스크·척추관협착증·무릎관절염·오십견 – 수정한의원"/>
  <meta name="twitter:description" content="허리디스크(추간판탈출증), 척추관협착증, 무릎관절염, 오십견·회전근개 손상. 수술 없이 8체질 침치료·추나·한약으로 통증 근본 해소. 노원구 한의원. ☎ 02-932-3815"/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"척추·관절 클리닉","item":"https://8chejil-sujeong.com/clinic/spine"}]},{"@type":"MedicalCondition","name":"허리디스크(추간판탈출증)"},{"@type":"MedicalCondition","name":"척추관협착증"},{"@type":"MedicalCondition","name":"무릎관절염"},{"@type":"MedicalCondition","name":"오십견·회전근개 손상"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 척추·관절 클리닉</div>
    <h1>척추·관절질환 클리닉</h1>
    <p>구조와 체질을 함께 고려하는 통합 치료</p>
  </div>
</section>

<section class="clinic-intro bg-cream">
  <div class="section-container">
    <div class="clinic-intro-badge"><i class="fas fa-bone"></i> 척추·관절질환 클리닉</div>

    <div class="auto-wrap">

      <!-- Hero -->
      <div class="auto-hero-box" style="background: linear-gradient(135deg, #1a1200 0%, #4a3000 60%, #2a1a00 100%);">
        <div class="auto-hero-main">통증만 따라가는 치료는 끝이 없습니다.<br/>구조를 바로잡고, 체질에서 답을 찾으세요.</div>
        <div class="auto-hero-sub">디스크, 협착증, 관절염, 오십견, 턱관절 — 수정한의원은 X-ray·MRI 구조 분석 + 8체질 기능 진단으로<br/><strong style="color:#ffd97a;">통증의 원인을 입체적으로 파악합니다.</strong></div>
      </div>

      <!-- 질환표 -->
      <div class="auto-q-block">
        <div class="auto-q-title" style="background:#fdf8ee; color:#3a2200; border-bottom-color:#e8c97a;">
          <span class="auto-qnum" style="background:#4a3000;"><i class="fas fa-list" style="font-size:0.75rem;"></i></span>
          <span>이런 척추·관절 질환을 치료합니다</span>
        </div>
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead>
                <tr><th>질환</th><th>주요 증상</th></tr>
              </thead>
              <tbody>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">허리디스크 (요추 추간판탈출증)</h4></td><td>허리·목 통증, 팔·다리 저림·방사통, 기침·재채기 시 악화</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">목디스크 (경추 추간판탈출증)</h4></td><td>목 통증, 어깨·팔 저림, 두통, 손 저림 증상</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">척추관 협착증</h4></td><td>걸으면 다리가 저리고 무거워짐, 쉬면 나아짐(간헐적 파행), 허리를 구부리면 편함</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">척추전방전위증</h4></td><td>허리 불안정감, 오래 서 있거나 걸으면 허리·다리 통증, 척추가 앞으로 밀린 상태</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">무릎 관절염</h4></td><td>계단 오르내릴 때 통증, 무릎 부종·열감, 관절 가동범위 감소</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">오십견 (어깨 회전근개 손상)</h4></td><td>어깨를 올리거나 뒤로 젖힐 때 극심한 통증, 야간통, 점진적 운동 제한</td></tr>
                <tr><td class="att-label"><h4 style="margin:0; font-size:1rem; font-weight:600; color:inherit;">턱관절 장애 (TMD)</h4></td><td>입 벌릴 때 통증·소리, 두통·이명·어지럼증 동반, 안면 비대칭</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>같은 디스크인데 왜 사람마다 경과가 다른가요?</span>
        </div>
        <div class="auto-q-body">
          <p>같은 추간판 탈출이라도 회복 속도, 염증 반응, 통증 민감도는 체질마다 다릅니다.</p>
          <div class="auto-constitution-list">
            <div class="auto-const-item">
              <span class="auto-const-icon">🟢</span>
              <span><strong>목양·목음체질</strong> — 간·담이 강하고 폐·대장이 약해 근육·인대의 재생력이 상대적으로 떨어지고, 만성 염증으로 진행하기 쉬움</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">⚪</span>
              <span><strong>금양·금음체질</strong> — 간이 약해 근건(筋腱) 영양 공급이 부족, 인대·연골 퇴행이 빨라 관절 질환에 취약</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🟡</span>
              <span><strong>토양·토음체질</strong> — 위장·췌장 과항진으로 체내 습열(濕熱)이 축적되어 관절 부종·염증이 잘 생김</span>
            </div>
            <div class="auto-const-item">
              <span class="auto-const-icon">🔵</span>
              <span><strong>수양·수음체질</strong> — 위장이 차갑고 약해 영양 흡수가 떨어지고, 뼈·연골에 필요한 영양 공급이 부족 → 퇴행이 빠름</span>
            </div>
          </div>
          <div class="auto-highlight-box"><strong>핵심:</strong> X-ray·MRI로 보이는 구조적 손상은 같아도, 체질에 따라 염증 패턴·회복력·재발 위험이 다릅니다. <strong>구조와 체질을 함께 봐야 치료가 완성됩니다.</strong></div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>왜 주사·진통제로는 한계가 있나요?</span>
        </div>
        <div class="auto-q-body">
          <p>양방에서는 통증 부위에 집중합니다 — 진통제, 스테로이드 주사, 신경차단술, 수술. 이러한 치료는 급성 통증 조절에는 효과적이지만, 통증이 생기는 <strong>구조적 원인(척추 정렬 불균형·근막 긴장·자율신경 교란)</strong>과 <strong>체질적 원인(장부 불균형에 의한 근건 약화·염증 체질)</strong>은 다루지 않습니다.</p>
          <div class="auto-highlight-box">주사를 맞으면 일시적으로 좋아지다가 다시 아프고, <strong>수술 후에도 인접 부위에 문제가 재발하는 이유</strong>가 바로 여기에 있습니다.</div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>경추 1‑2 교정·턱관절 교정이 척추·관절과 무슨 관계인가요?</span>
        </div>
        <div class="auto-q-body">
          <p><strong>경추 1‑2번(상부 경추)</strong>은 척추 전체 정렬의 기준점이자, 미주신경(제10뇌신경)이 출발하는 뇌간과 직결되는 구간입니다. 상부 경추가 틀어지면 아래쪽 흉추·요추·골반까지 보상적 변위가 연쇄적으로 발생합니다.</p>
          <p><strong>턱관절(TMJ)</strong>은 삼차신경·안면신경을 통해 경추와 직접 연결되어 있으며, 턱관절 불균형은 경추 긴장 → 어깨·흉추 변위 → 요추·골반 틀어짐으로 이어지는 <strong>하향 연쇄(descending pattern)</strong>의 시발점이 될 수 있습니다.</p>
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              <thead>
                <tr><th>교정 부위</th><th>척추·관절에 미치는 효과</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td class="att-label">경추 1‑2 추나 교정</td>
                  <td>척추 정렬의 기준점 복원 → 흉추·요추·골반 보상 변위 해소, 미주신경 기시부 압박 해소 → 전신 근긴장·염증 조절 정상화</td>
                </tr>
                <tr>
                  <td class="att-label">턱관절 교정</td>
                  <td>상행·하행 연쇄 차단 → 경추·어깨·흉추 긴장 완화, 두통·이명·어지럼증 동반 증상 해소</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="auto-highlight-box"><strong>핵심:</strong> 허리가 아파도 원인이 경추·턱관절에 있을 수 있고, 어깨가 아파도 원인이 골반에 있을 수 있습니다. 수정한의원은 통증 부위가 아닌, <strong>척추 전체 정렬과 상부 경추·턱관절의 기준점부터 교정</strong>합니다.</div>
        </div>
      </div>
        ...
        <div class="auto-q-body">
          <div class="auto-table-wrap">
            <table class="auto-treat-table">
              ...
              <tbody>
                <tr>
                  <td class="att-label"><i class="fas fa-search"></i> 정확한 8체질 진단</td>
                  <td>30년·21,560건 데이터 기반 체질 확정 → 염증 패턴·회복력·재발 위험의 체질적 원인 파악</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-leaf"></i> 체질 맞춤 한약</td>
                  <td>근건·뼈·연골 영양 보강, 체질별 염증 체질 개선, 장부 균형 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-x-ray"></i> X-ray·MRI 구조 분석</td>
                  <td>디스크·협착·전위·관절 손상의 정확한 위치와 정도 확인</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-bone"></i> 경추 1‑2 교정 추나요법</td>
                  <td>척추 정렬 기준점 복원 + 미주신경 압박 해소</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-teeth"></i> 턱관절(TMJ) 교정</td>
                  <td>상행·하행 연쇄 차단, 경추-어깨-흉추 긴장 해소</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-arrows-alt-v"></i> 척추·골반 추나요법</td>
                  <td>흉추·요추·골반의 구조적 변위를 직접 교정 → 디스크·신경 압박 경감</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 척추 배수혈 침 치료</td>
                  <td>자율신경이 장기로 분지되는 척추 옆 경혈 자극 → 해당 부위 혈류 개선·염증 억제·근긴장 완화</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-acupuncture-person"></i> 8체질 침 치료</td>
                  <td>체질별 장부 강약에 따른 전신 균형 조율 → 근건 영양·재생력 회복</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-syringe"></i> 약침요법</td>
                  <td>소염·진통·신경 재생 성분을 통증 부위 경혈에 직접 주입 → 스테로이드 없이 염증 억제</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-thread"></i> 매선요법</td>
                  <td>약실을 근막·경혈에 매입 → 지속적 자극으로 인대 강화·통증 완화 효과 연장</td>
                </tr>
                <tr>
                  <td class="att-label"><i class="fas fa-circle-dot"></i> 양자돔 + 생활관리</td>
                  <td>전신 이완·회복, 체질별 운동·자세·식이 지도</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="auto-flow-box">
            <strong>치료 흐름:</strong> 체질 진단 + 한약 → 영상 분석 → 기준점 교정(경추·턱관절) → 척추·골반 구조 교정(추나) → 신경·근막 치료(배수혈·체질침·약침·매선) → 전신 회복(양자돔) → 체질별 운동·생활 관리
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        <div class="auto-q-title">
          ...
          <span>수술 없이도 가능한가요?</span>
        </div>
        <div class="auto-q-body">
          <p>대부분 가능합니다. 추나 교정으로 척추 정렬을 바로잡고, 약침으로 염증을 억제하며, 체질 한약으로 근건·인대를 강화하면 수술 없이 구조적 안정성을 회복할 수 있습니다.</p>
          <div class="auto-highlight-box" style="border-left-color:#b87a00; background:#fff8e1;">
            다만 심한 마비 증상·대소변 장애 등 응급 수술이 필요한 경우도 있습니다. <strong>수술 후에도 체질 치료를 병행하면</strong> 면역력을 강화하여 재발 방지와 회복 촉진에 도움이 됩니다.
          </div>
        </div>
      </div>
      ...
      <div class="auto-q-block">
        ...
        <div class="auto-q-body">
          <div class="auto-highlight-box" style="border-left-color:#2e7d32; background:#f1f8f3;">
            ...
            현재 받고 있는 진통제, 물리치료, 주사 치료 등을 유지하면서 체질 치료를 병행할 수 있습니다. 수술 후 재활 과정에서도 추나·약침·체질 한약을 병행하면 회복 기간 단축과 인접 부위 재발 방지에 도움이 됩니다. 진료 시 현재 치료 상황을 알려주시면 통합 계획을 수립합니다.
          </div>
        </div>
      </div>

      <!-- CTA -->
      <div class="sdi-cta-box" style="margin-top:28px;">
        <div class="sdi-cta-concerns">
          <span>"주사 맞으면 잠깐 좋다가 다시 아파요"</span>
          <span>"디스크 수술 권유를 받았는데 고민이에요"</span>
          <span>"걸으면 다리가 저려서 오래 못 걸어요"</span>
          <span>"어깨가 안 올라가서 일상이 불편해요"</span>
          <span>"턱에서 소리가 나고 두통까지 생겨요"</span>
        </div>
        <p class="sdi-cta-lead">척추·관절 통증은 <strong>구조의 문제이자, 체질의 문제</strong>입니다.<br/>X-ray·MRI 분석 + 경추·턱관절 교정 + 8체질 통합 치료로 근본 원인을 해결하세요.</p>
