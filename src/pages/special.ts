export const specialPage = `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>수정한의원의 특별함 | 8체질 진단·체질한약·OMNIFIT·DITI·초음파</title>
  <meta name="description" content="정확한 8체질 진단(OMNIFIT 자율신경검사·DITI 적외선체열·Bodygen 초음파·InBody·Sensitiv imago). 체질 맞춤 1:1 한약처방. 금양·금음·목양·목음·토양·토음·수양·수음 8가지 체질별 맞춤 치료."/>
  ...
  <link rel="canonical" href="https://www.8chejil-sujeong.com/special"/>

  <!-- Open Graph -->
  <meta property="og:title" content="수정한의원의 특별함 | 8체질 진단·체질한약·OMNIFIT·DITI·초음파"/>
  <meta property="og:description" content="정확한 8체질 진단(OMNIFIT 자율신경검사·DITI 적외선체열·Bodygen 초음파·InBody·Sensitiv imago). 체질 맞춤 1:1 한약처방. 금양·금음·목양·목음·토양·토음·수양·수음 8가지 체질별 맞춤 치료."/>
  ...
  <meta property="og:url" content="https://www.8chejil-sujeong.com/special"/>
  <meta property="og:locale" content="ko_KR"/>
  <meta property="og:site_name" content="수정한의원"/>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:title" content="수정한의원의 특별함 | 8체질 진단·체질한약·OMNIFIT·DITI·초음파"/>
  <meta name="twitter:description" content="정확한 8체질 진단(OMNIFIT 자율신경검사·DITI 적외선체열·Bodygen 초음파·InBody·Sensitiv imago). 체질 맞춤 1:1 한약처방. 금양·금음·목양·목음·토양·토음·수양·수음 8가지 체질별 맞춤 치료."/>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"수정한의원","item":"https://8chejil-sujeong.com"},{"@type":"ListItem","position":2,"name":"수정한의원의 특별함","item":"https://8chejil-sujeong.com/special"}]}</script>
...
<section class="page-hero green">
  <div class="page-hero-content">
    <div class="page-breadcrumb"><a href="/">홈</a> <i class="fas fa-chevron-right"></i> 수정한의원의 특별함</div>
    <h1>수정한의원의 특별함</h1>
    <p>같은 병도 체질이 다르면 원인도 치료도 달라집니다</p>
  </div>
</section>

<!-- 1. 정확한 8체질 진단 -->
<section id="diagnosis" class="bg-cream">
  <div class="section-container">
    <div class="feature-section-grid">
      <div class="feature-num-block">
        <span class="big-num">01</span>
        <div class="section-label">DIAGNOSIS</div>
      </div>
      <div class="feature-content">
        <h2 class="section-title">정확한 <span>8체질 진단</span></h2>
        <p class="feature-lead">8체질 전문 한의학박사가 30년 임상경험과 최신 의료장비로 정확한 체질과 병의 근본 원인을 진단합니다</p>

        <div class="feature-cards">
          <div class="feat-card">
            <div class="feat-icon"><i class="fas fa-user-doctor"></i></div>
            <h4>8체질 전문 한의학박사 진료</h4>
            <p>침구학 전공 한의학박사가 직접 진료합니다. 정밀한 맥진과 함께 30년 임상에서 축적된 체질진단 프로세스로 정확한 체질을 감별합니다.</p>
          </div>
          <div class="feat-card">
            <div class="feat-icon"><i class="fas fa-microscope"></i></div>
            <h4>최신 의료장비와 세밀한 검진</h4>
            <p>정확한 8체질 진단과 원내에 보유한 OMNIFIT(자율신경·뇌파검사), DITI(적외선 체열진단기), SimplexTAS 101(혈액검사기), InBody J50(체성분분석기), Sensitiv imago(파동검사), Bodygen Ultrasound(초음파진단기) 등의 최신 의료기기와 X-ray, MRI 분석을 통해 병의 근본 원인을 파악합니다.</p>
          </div>
          <div class="feat-card">
            <div class="feat-icon"><i class="fas fa-dna"></i></div>
            <h4>같은 병도 체질이 다르면 원인도 다릅니다</h4>
            <p>동일한 증상이라도 체질에 따라 원인과 치료법이 전혀 달라집니다. 체질을 모르면 진정한 근본치료가 어렵습니다.</p>
          </div>
          <div class="feat-card">
            <div class="feat-icon"><i class="fas fa-shield-halved"></i></div>
            <h4>8체질 식이요법과 섭생법</h4>
            <p>정확한 체질 진단을 통해 체질에 맞는 음식과 생활 습관을 안내하여 병의 예방과 재발 방지까지 도웁니다.</p>
          </div>
        </div>
        ...
        <div class="constitution-types">
          ...
          <div class="types-grid">
            <a href="/eight-constitution?const=금양#food" class="type-item ti-metal"><span>금양체질</span></a>
            <a href="/eight-constitution?const=금음#food" class="type-item ti-metal2"><span>금음체질</span></a>
            <a href="/eight-constitution?const=목양#food" class="type-item ti-wood"><span>목양체질</span></a>
            <a href="/eight-constitution?const=목음#food" class="type-item ti-wood2"><span>목음체질</span></a>
            <a href="/eight-constitution?const=토양#food" class="type-item ti-fire"><span>토양체질</span></a>
            <a href="/eight-constitution?const=토음#food" class="type-item ti-fire2"><span>토음체질</span></a>
            <a href="/eight-constitution?const=수양#food" class="type-item ti-water"><span>수양체질</span></a>
            <a href="/eight-constitution?const=수음#food" class="type-item ti-water2"><span>수음체질</span></a>
          </div>
          <p class="types-note">각 체질별로 장기의 강약 구조가 다르며, 이에 따라 걸리기 쉬운 병과 치료법이 달라집니다</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- 2. 체질한약 -->
<section id="medicine" class="bg-dark-green">
  <div class="section-container">
    <div class="feature-section-grid reverse">
      <div class="feature-num-block light">
        <span class="big-num">02</span>
        <div class="section-label light">MEDICINE</div>
      </div>
      <div class="feature-content">
        <h2 class="section-title light">체질한약이 <span class="gold-text">특별한 이유</span></h2>
        <p class="feature-lead light">한약 잘 짓는 한의원을 찾으셨나요?<br/>한의학 치료의 정수는 탕약입니다</p>

        <div class="medicine-points">
          <div class="med-point">
            <div class="med-num">01</div>
            <div class="med-text">
              <h4>정확하고 세밀한 1:1 맞춤 체질 한약</h4>
              <p>단순히 증상만 보고 처방하지 않습니다. 정확한 8체질 진단을 통해 병의 근본원인을 파악하고 1:1 맞춤 한약을 처방합니다.</p>
            </div>
          </div>
          <div class="med-point">
            <div class="med-num">02</div>
            <div class="med-text">
              <h4>한의원 내 직접 조제·탕전</h4>
              <p>원내에 갖춰진 탕전실에서 한의사가 직접 조제하고 정성껏 달이는 정성 한약. 처방부터 약재 선별, 탕전 관리까지 철저하게 시행합니다.</p>
            </div>
          </div>
          <div class="med-point">
            <div class="med-num">03</div>
            <div class="med-text">
              <h4>GMP인증 약재 사용 + 안전성 확보</h4>
              <p>식약처 GMP인증을 받은 깨끗하고 안전한 한약재를 사용합니다. 한약 복용 중 간·신장 혈액검사를 통한 안전성을 확보합니다.</p>
            </div>
          </div>
          <div class="med-point">
            <div class="med-num">04</div>
            <div class="med-text">
              <h4>속 편하게 하루 5~6회 복용 가능</h4>
              <p>한약을 먹을 때마다 속이 불편해서 못 먹던 분들도 체질에 맞는 한약은 물처럼 편하게 복용할 수 있습니다. 만성·난치질환의 꾸준한 복용에 적합합니다.</p>
            </div>
          </div>
        </div>
      </div>
...
<!-- 3. 양자퀀텀 면역센터 -->
<section id="quantum" class="bg-cream-warm">
  <div class="section-container">
    <div class="feature-section-grid">
      <div class="feature-num-block">
        <span class="big-num">03</span>
        <div class="section-label">QUANTUM</div>
      </div>
      <div class="feature-content">
        <h2 class="section-title">양자퀀텀 <span>면역센터</span></h2>
        <p class="feature-lead">비용 부담 없이 이용 가능한 첨단 면역 치료 시설</p>

        <div class="quantum-grid">
          <div class="quantum-card">
            <div class="quantum-icon"><i class="fas fa-temperature-high"></i></div>
            <h4>양자온열치료실</h4>
            <div class="quantum-quote">
              <p>"체온을 1도 올리면 면역이 <strong>5배</strong> 높아진다"</p>
              <p>"체온이 1도 떨어지면 면역이 <strong>30배</strong> 떨어진다"</p>
            </div>
            <p>양자온열치료는 일반적인 온열 방식과 완전히 다릅니다. 단순히 피부 표면을 데우는 것이 아니라, 광자화된 파동 에너지를 세포 단위까지 깊게 전달하여 세포 활동을 촉진함으로써 면역 기능을 활성화하고 자연 치유력을 높입니다.</p>

            <!-- 일반 온열 vs 양자 온열 비교표 -->
            <div class="quantum-compare">
              <div class="quantum-compare-title"><i class="fas fa-table-cells"></i> 일반 온열 vs 양자 온열</div>
              <table class="quantum-compare-table">
                <thead>
                  <tr>
                    <th></th>
                    <th>일반 온열</th>
                    <th class="th-quantum">양자 온열</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td class="td-label">방식</td>
                    <td>표면 가열</td>
                    <td class="td-quantum">세포 깊숙이 파동 에너지 전달</td>
                  </tr>
                  <tr>
                    <td class="td-label">작용</td>
                    <td>피부 표면 온도 상승</td>
                    <td class="td-quantum">세포 단위 활동 촉진</td>
                  </tr>
                  <tr>
                    <td class="td-label">효과</td>
                    <td>일시적 따뜻함</td>
                    <td class="td-quantum">면역 기능 활성화 + 자연 치유력</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <!-- 비용 부담 없이 강조 배너 -->
            <div class="quantum-free-banner">
              <i class="fas fa-circle-check"></i>
              <span>수정한의원 내원 시 <strong>비용 부담 없이 이용 가능</strong>합니다</span>
            </div>
          </div>
          <div class="quantum-card">
            <div class="quantum-icon"><i class="fas fa-wave-square"></i></div>
            <h4>파동요법실</h4>
            <p>빛(광파)과 소리(음파)의 파동 에너지를 이용하여 세균, 박테리아, 바이러스에 대한 인체조직의 생리학적 반응을 유도합니다. 신체 깊숙이 작용하는 에너지 파동요법으로, 자연스러운 면역 활성화를 돕습니다.</p>

            <div class="quantum-detail">
              <div class="padong-section-title">
                <i class="fas fa-bolt" style="color:#c9a227;"></i>
                <span>빔레이(Beam Ray) 파동요법</span>
              </div>
              <p class="beamray-sub"><strong>1920년대 개발, 100년 이상 검증</strong></p>
              <p>로열 레이몬드 라이프가 개발한 이론에 기반한 저에너지 전자기장을 이용합니다. '생체 공명'과 '특정 주파수'의 원리를 활용하여 몸 속 병원균에 직접 작용하는 방식입니다.</p>
            </div>

            <!-- 추천 대상 -->
            <div class="beamray-recommend">
              <div class="padong-section-title recommend-title">
                <i class="fas fa-star" style="color:#c9a227;"></i>
                <span>이런 분들께 추천드립니다</span>
              </div>
              <ul class="beamray-list">
                <li><span class="br-dot">🔸</span> 암 환자, 자가면역질환 보조 요법</li>
                <li><span class="br-dot">🔸</span> 세균, 박테리아, 바이러스 감염 보조 요법</li>
                <li><span class="br-dot">🔸</span> 반복되는 만성 감염성 질환 보조 요법</li>
                <li><span class="br-dot">🔸</span> 면역력 강화 및 자연 치유력 회복</li>
                <li><span class="br-dot">🔸</span> 항생제 내성 문제 없는 대체 요법</li>
              </ul>
            </div>
          </div>
        </div>

        <div class="immune-benefit">
          <h3>면역센터 치료 효과</h3>
          <div class="benefit-list">
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 면역력 강화 및 자연 치유력 향상</div>
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 암 환자 보조 치료</div>
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 만성 피로 개선</div>
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 체온 정상화 및 혈액순환 개선</div>
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 자율신경 조절</div>
            <div class="benefit-item"><i class="fas fa-check-circle"></i> 면역질환 보조 치료</div>
          </div>
        </div>
      </div>
    </div>
